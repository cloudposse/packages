...
hugo                      0.123.0    The world’s fastest framework for building websites.
...
popeye                    0.20.2     A Kubernetes cluster resource sanitizer
...
terragrunt                0.55.4     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
