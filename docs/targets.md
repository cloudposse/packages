...
atlantis                  0.37.1     Terraform For Teams
atmos                     1.199.0    Universal Tool for DevOps and Cloud Automation
...
conftest                  0.64.0     Test your configuration files using Open Policy Agent
consul                    1.16.4     Hashicorp consul
ctop                      0.7.7      Top-like interface for container metrics
direnv                    2.37.1     Unclutter your .profile
doctl                     1.147.0    A command line tool for DigitalOcean services
...
ecspresso                 2.6.4      Ecspresso is a deployment tool for Amazon ECS
...
gitleaks                  8.29.1     Audit git repos for secrets 🔑
...
helm                      4.0.1      The Kubernetes Package Manager
helm2                     2.17.0     The Kubernetes Package Manager
helm3                     3.19.2     The Kubernetes Package Manager
...
kubectl                   1.34.2     Production-Grade Container Scheduling and Management
...
kubectl-1.32              1.32.10    Production-Grade Container Scheduling and Management (v1.32)
...
opa                       1.10.1     An open source project to policy-enable your service.
...
sentry-cli                2.58.2     A command line utility to work with Sentry.
...
teleport                  18.4.1     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.93.10    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
yq                        4.49.1     yq is a portable command-line YAML processor
```
