...
argocd                    1.7.8      Declarative GitOpts for Kubernetes
...
aws-okta                  1.0.3      aws-okta allows users to authenticate with AWS using Okta credentials
...
cloudflared               2020.10.0  Argo Tunnel client
cloudposse-atlantis       0.9.0.3    Terraform For Teams, enhanced by Cloud Posse
codefresh                 0.73.16    Codefresh CLI
conftest                  0.21.0     Test your configuration files using Open Policy Agent
consul                    1.8.4      Hashicorp consul
ctop                      0.7.4      Top-like interface for container metrics
direnv                    2.23.1     Unclutter your .profile
doctl                     1.51.0     A command line tool for DigitalOcean services
...
helm                      3.4.0      The Kubernetes Package Manager
helm2                     2.16.10    The Kubernetes Package Manager
helm3                     3.3.4      The Kubernetes Package Manager
helmfile                  0.132.2    Deploy Kubernetes Helm Charts
htmltest                  0.13.0     :white_check_mark: Test generated HTML for problems
hugo                      0.78.1     The world’s fastest framework for building websites.
jp                        0.1.3      Command line interface to JMESPath
jq                        1.6        Command-line JSON processor
json2hcl                  0.0.6      Convert JSON to HCL, and vice versa
jx                        2.1.138    Jenkins-X
k3d                       3.2.0      Little helper to run Rancher Lab's k3s in Docker
k6                        0.28.0     A modern load testing tool, using Go and JavaScript - https://k6.io
k9s                       0.23.5     Kubernetes CLI To Manage Your Clusters In Style
...
kubectl                   1.19.1     Production-Grade Container Scheduling and Management
...
kubectl-1.17              1.17.12    Production-Grade Container Scheduling and Management (v1.17)
kubectl-1.18              1.18.10    Production-Grade Container Scheduling and Management (v1.18)
kubectl-1.19              1.19.1     Production-Grade Container Scheduling and Management (v1.19)
...
minikube                  1.14.2     Run Kubernetes locally
misspell                  0.3.4      Correct commonly misspelled English words in source files
nomad                     0.12.5     Hashicorp nomad
opa                       0.24.0     An open source project to policy-enable your service.
pack                      0.14.2     Create cloud native Buildpacks
...
sentry-cli                1.59.0     A command line utility to work with Sentry.
shellcheck                0.7.1      ShellCheck, a static analysis tool for shell scripts
shfmt                     3.2.0      A shell parser, formatter and interpreter (POSIX/Bash/mksh)
...
terraform                 0.13.5     Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-0.13            0.13.4     Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform_0.13            0.13.4     Terraform (Deprecated package. Use terraform-0.13 instead)
terraform_0.14            0.14.0-rc1 Terraform (Deprecated package. Use terraform-0.14 instead)
terragrunt                0.26.0     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
thanos                    0.16.0     Highly available Prometheus setup with long term storage capabilities. CNCF Sandbox project.
trivy                     0.12.0     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
vault                     1.5.5      Hashicorp vault
vendir                    0.12.0     Easy way to vendor portions of git repos, github releases, etc. declaratively
