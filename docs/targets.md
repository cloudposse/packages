...
minikube                  1.23.1     Run Kubernetes locally
...
terragrunt                0.32.2     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
