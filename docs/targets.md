...
doctl                     1.129.0    A command line tool for DigitalOcean services
...
terragrunt                0.81.0     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
