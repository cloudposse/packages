...
atmos                     1.200.0    Universal Tool for DevOps and Cloud Automation
...
terragrunt                0.93.11    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
yq                        4.49.2     yq is a portable command-line YAML processor
```
