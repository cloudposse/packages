...
atmos                     1.106.0    Universal Tool for DevOps and Cloud Automation
...
promtool                  2.55.1     Prometheus CLI tool
...
terragrunt                0.68.13    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
