...
atmos                     1.195.0    Universal Tool for DevOps and Cloud Automation
...
promtool                  3.7.2      Prometheus CLI tool
...
teleport                  18.2.10    Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.92.0     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
thanos                    0.40.0     Highly available Prometheus setup with long term storage capabilities. CNCF Sandbox project.
