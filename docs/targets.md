...
cloudflared               2024.9.0   Argo Tunnel client
...
doctl                     1.113.0    A command line tool for DigitalOcean services
...
kops                      1.30.0     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
pandoc                    3.3        Universal markup converter
...
spacectl                  1.3.2      [Spacelift.io](https://spacelift.io/) client and CLI
...
teleport                  16.2.1     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.67.4     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.55.0     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
vendir                    0.41.1     Easy way to vendor portions of git repos, github releases, helm charts, docker image contents, etc. declaratively.
