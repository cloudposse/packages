...
saml2aws                  2.36.5     CLI tool which enables you to login and retrieve AWS temporary credentials using a SAML IDP
scenery                   0.1.5      A Terraform plan output prettifier
sentinel                  OBSOLETE   Hashicorp sentinel
sentry-cli                2.16.0     A command line utility to work with Sentry.
