...
teleport                  14.1.5     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.53.4     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
