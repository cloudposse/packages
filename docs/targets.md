...
atmos                     1.20.0     Universal Tool for DevOps and Cloud Automation
...
teleport                  11.2.0     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.42.7     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
