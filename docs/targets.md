...
argocd                    2.1.3      Declarative GitOpts for Kubernetes
assume-role               0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.17.3     Terraform For Teams
atmos                     1.2.1      Universal Tool for DevOps and Cloud Automation
...
jx                        3.2.205    Jenkins-X
k3d                       5.0.1      Little helper to run Rancher Lab's k3s in Docker
k6                        0.34.1     A modern load testing tool, using Go and JavaScript - https://k6.io
k9s                       0.24.15    Kubernetes CLI To Manage Your Clusters In Style
...
kops                      1.21.2     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
kubectl                   1.22.2     Production-Grade Container Scheduling and Management
...
kubectl-1.19              1.19.15    Production-Grade Container Scheduling and Management (v1.19)
kubectl-1.20              1.20.11    Production-Grade Container Scheduling and Management (v1.19)
...
minikube                  1.23.2     Run Kubernetes locally
misspell                  0.3.4      Correct commonly misspelled English words in source files
nomad                     OBSOLETE   Hashicorp nomad
opa                       0.33.1     An open source project to policy-enable your service.
pack                      0.21.1     Create cloud native Buildpacks
packer                    1.7.6      Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
pandoc                    2.14.2     Universal markup converter
pgmetrics                 1.12.0     Postgres metrics
pluto                     5.0.1      A cli tool to help discover deprecated apiVersions in Kubernetes
popeye                    0.9.7      A Kubernetes cluster resource sanitizer
promtool                  2.30.3     Prometheus CLI tool
...
sentry-cli                1.69.1     A command line utility to work with Sentry.
shellcheck                0.7.2      ShellCheck, a static analysis tool for shell scripts
shfmt                     3.4.0      A shell parser, formatter and interpreter (POSIX/Bash/mksh)
...
teleport                  7.3.0      Secure Access for Developers that doesn't get in the way.
...
terraform                 1.0.9      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.0.9      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terragrunt                0.35.2     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.20.0     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
yq                        4.13.4     yq is a portable command-line YAML processor
```
