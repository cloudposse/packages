...
argocd                    2.11.6     Declarative GitOpts for Kubernetes
...
sentry-cli                2.32.2     A command line utility to work with Sentry.
...
terragrunt                0.63.3     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
