...
atmos                     1.3.4      Universal Tool for DevOps and Cloud Automation
...
doctl                     1.66.0     A command line tool for DigitalOcean services
...
hugo                      0.89.0     The world’s fastest framework for building websites.
jp                        0.2.1      Command line interface to JMESPath
jq                        1.6.0      Command-line JSON processor
json2hcl                  0.0.6      Convert JSON to HCL, and vice versa
jx                        3.2.213    Jenkins-X
k3d                       5.0.3      Little helper to run Rancher Lab's k3s in Docker
...
opa                       0.34.1     An open source project to policy-enable your service.
...
promtool                  2.31.0     Prometheus CLI tool
...
terraform                 1.0.10     Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.0.10     Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terragrunt                0.35.6     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
venona                    1.6.9      Codefresh runtime-environment agent
