...
atmos                     1.54.0     Universal Tool for DevOps and Cloud Automation
...
cloudflared               2024.1.3   Argo Tunnel client
...
k9s                       0.31.5     Kubernetes CLI To Manage Your Clusters In Style
...
sentry-cli                2.25.1     A command line utility to work with Sentry.
...
terraform-1               1.7.0      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terragrunt                0.54.18    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
