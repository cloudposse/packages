...
hugo                      0.104.1    The world’s fastest framework for building websites.
...
k9s                       0.26.6     Kubernetes CLI To Manage Your Clusters In Style
...
sentry-cli                2.6.0      A command line utility to work with Sentry.
...
teleport                  10.2.4     Secure Access for Developers that doesn't get in the way.
