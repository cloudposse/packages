...
argocd                    3.1.9      Declarative GitOpts for Kubernetes
assume-role*              0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.36.0     Terraform For Teams
atmos                     1.196.0    Universal Tool for DevOps and Cloud Automation
...
aws-iam-authenticator     0.7.8      A tool to use AWS IAM credentials to authenticate to a Kubernetes cluster
...
cilium-cli                0.18.8     CLI to install, manage & troubleshoot Kubernetes clusters running Cilium
cli53                     0.8.25     Command line tool for Amazon Route 53
cloud-nuke                0.44.0     Tool for wiping an aws account DANGER absolutely do not use in production
cloudflared               2025.10.1  Argo Tunnel client
cloudposse-atlantis       OBSOLETE   Terraform For Teams, enhanced by Cloud Posse
codefresh                 0.89.3     Codefresh CLI
conftest                  0.63.0     Test your configuration files using Open Policy Agent
...
ecspresso                 2.6.2      Ecspresso is a deployment tool for Amazon ECS
...
helm                      3.19.0     The Kubernetes Package Manager
helm2                     2.17.0     The Kubernetes Package Manager
helm3                     3.19.0     The Kubernetes Package Manager
...
infracost                 0.10.42    Cloud cost estimates for Terraform
...
jx                        3.16.26    Jenkins-X
k3d                       5.8.3      Little helper to run Rancher Lab's k3s in Docker
k6                        1.3.0      A modern load testing tool, using Go and JavaScript - https://k6.io
...
kind                      0.30.0     A tool for running local Kubernetes clusters using Docker
kops                      1.34.0     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
kubectl                   1.34.1     Production-Grade Container Scheduling and Management
...
kubectl-1.31              1.31.13    Production-Grade Container Scheduling and Management (v1.31)
kubectl-1.32              1.32.9     Production-Grade Container Scheduling and Management (v1.32)
...
opa                       1.10.0     An open source project to policy-enable your service.
...
pandoc                    3.8.2.1    Universal markup converter
pgmetrics                 1.18.0     Postgres metrics
pluto                     5.22.6     A cli tool to help discover deprecated apiVersions in Kubernetes
popeye                    0.22.1     A Kubernetes cluster resource sanitizer
promtool                  3.7.3      Prometheus CLI tool
...
sentry-cli                2.57.0     A command line utility to work with Sentry.
...
stern                     1.33.0     ⎈ Multi pod and container log tailing for Kubernetes
sudosh                    0.3.0      Shell wrapper to run a login shell with `sudo` as the current user for the purpose of audit logging
teleport                  18.3.0     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.93.0     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
tflint                    0.59.1     A Pluggable Terraform Linter
...
trivy                     0.67.2     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
velero                    1.17.0     Backup and migrate Kubernetes applications and their persistent volumes
...
yq                        4.48.1     yq is a portable command-line YAML processor
```
