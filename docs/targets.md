...
atmos                     1.88.0     Universal Tool for DevOps and Cloud Automation
...
hugo                      0.134.0    The world’s fastest framework for building websites.
...
sentry-cli                2.34.1     A command line utility to work with Sentry.
...
spacectl                  1.3.1      [Spacelift.io](https://spacelift.io/) client and CLI
...
teleport                  16.2.0     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.67.1     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
