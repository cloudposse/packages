...
doctl                     1.96.0     A command line tool for DigitalOcean services
...
hugo                      0.112.3    The world’s fastest framework for building websites.
...
kubectl-1.25              1.25.9     Production-Grade Container Scheduling and Management (v1.25)
...
opa                       0.52.0     An open source project to policy-enable your service.
...
pluto                     5.16.3     A cli tool to help discover deprecated apiVersions in Kubernetes
...
spacectl                  0.20.0     [Spacelift.io](https://spacelift.io/) client and CLI
...
teleport                  13.0.3     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.45.16    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
