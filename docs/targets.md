...
helmfile                  0.139.3    Deploy Kubernetes Helm Charts
...
kops                      1.20.0     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
yq                        4.8.0      yq is a portable command-line YAML processor
```
