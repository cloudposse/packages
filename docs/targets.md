...
argocd                    2.10.9     Declarative GitOpts for Kubernetes
assume-role*              0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.27.3     Terraform For Teams
atmos                     1.71.0     Universal Tool for DevOps and Cloud Automation
...
kubectl-1.30              1.30.0     Production-Grade Container Scheduling and Management (v1.30)
...
sentry-cli                2.31.2     A command line utility to work with Sentry.
...
teleport                  15.3.0     Secure Access for Developers that doesn't get in the way.
...
terraform-config-inspect  0.0.20240507135902+git21dcc2942448 A helper library for shallow inspection of Terraform configurations
...
terragrunt                0.58.3     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
tflint                    0.51.0     A Pluggable Terraform Linter
...
trivy                     0.51.1     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
