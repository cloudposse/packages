...
atmos                     1.83.0     Universal Tool for DevOps and Cloud Automation
...
terragrunt                0.59.5     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
