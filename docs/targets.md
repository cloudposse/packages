...
argocd                    2.1.2      Declarative GitOpts for Kubernetes
...
chamber                   2.10.3     CLI for managing secrets
cli53                     0.8.18     Command line tool for Amazon Route 53
cloudflared               2021.8.7   Argo Tunnel client
...
hugo                      0.88.0     The world’s fastest framework for building websites.
jp                        0.1.3      Command line interface to JMESPath
jq                        1.6.0      Command-line JSON processor
json2hcl                  0.0.6      Convert JSON to HCL, and vice versa
jx                        3.2.188    Jenkins-X
k3d                       4.4.8      Little helper to run Rancher Lab's k3s in Docker
...
kops                      1.21.1     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
opa                       0.32.0     An open source project to policy-enable your service.
...
pluto                     5.0.0      A cli tool to help discover deprecated apiVersions in Kubernetes
popeye                    0.9.7      A Kubernetes cluster resource sanitizer
promtool                  2.29.2     Prometheus CLI tool
...
teleport                  7.1.0      Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.31.8     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
yq                        4.12.1     yq is a portable command-line YAML processor
```
