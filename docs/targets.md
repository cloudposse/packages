...
atmos                     1.83.1     Universal Tool for DevOps and Cloud Automation
...
aws-iam-authenticator     0.6.21     A tool to use AWS IAM credentials to authenticate to a Kubernetes cluster
...
doctl                     1.109.0    A command line tool for DigitalOcean services
...
k3d                       5.7.1      Little helper to run Rancher Lab's k3s in Docker
...
terragrunt                0.60.1     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
