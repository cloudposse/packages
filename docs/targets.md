...
argocd                    2.3.3      Declarative GitOpts for Kubernetes
assume-role               0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.19.3     Terraform For Teams
atmos                     1.4.15     Universal Tool for DevOps and Cloud Automation
...
kind                      0.13.0     A tool for running local Kubernetes clusters using Docker
...
kubectl                   1.24.0     Production-Grade Container Scheduling and Management
...
kubectl-1.21              1.21.12    Production-Grade Container Scheduling and Management (v1.21)
kubectl-1.22              1.22.9     Production-Grade Container Scheduling and Management (v1.22)
...
sentry-cli                2.0.4      A command line utility to work with Sentry.
...
spacectl                  0.9.1      [Spacelift.io](https://spacelift.io/) client and CLI
...
teleport                  9.2.3      Secure Access for Developers that doesn't get in the way.
...
terraform                 1.1.9      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.1.9      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
tfsec                     1.21.0     Security scanner for your Terraform code
thanos                    0.26.0     Highly available Prometheus setup with long term storage capabilities. CNCF Sandbox project.
trivy                     0.27.1     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
