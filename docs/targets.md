...
pandoc                    3.1.6.2    Universal markup converter
...
teleport                  13.3.5     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.50.6     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
thanos                    0.32.0     Highly available Prometheus setup with long term storage capabilities. CNCF Sandbox project.
