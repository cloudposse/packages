...
atmos                     1.129.0    Universal Tool for DevOps and Cloud Automation
...
gomplate                  4.2.0      A flexible commandline tool for template rendering. Supports lots of local and remote datasources.
...
hugo                      0.139.4    The world’s fastest framework for building websites.
...
pack                      0.36.0     Create cloud native Buildpacks
...
terragrunt                0.69.13    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
