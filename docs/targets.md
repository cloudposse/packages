...
k6                        0.34.0     A modern load testing tool, using Go and JavaScript - https://k6.io
...
terragrunt                0.31.9     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
yq                        4.12.2     yq is a portable command-line YAML processor
```
