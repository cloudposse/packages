...
opa                       1.11.1     An open source project to policy-enable your service.
...
terragrunt                0.96.0     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
