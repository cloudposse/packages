...
sentry-cli                2.4.1      A command line utility to work with Sentry.
...
teleport                  10.0.1     Secure Access for Developers that doesn't get in the way.
...
trivy                     0.30.0     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
vendir                    0.29.0      Easy way to vendor portions of git repos, github releases, helm charts, docker image contents, etc. declaratively.
...
yq                        4.26.1     yq is a portable command-line YAML processor
```
