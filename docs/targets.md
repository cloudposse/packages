...
lectl*                    0.22.0     Script to check issued certificates by Let's Encrypt on CTL (Certificate Transparency Log) using https://crt.sh
...
sentry-cli                2.20.0     A command line utility to work with Sentry.
...
terraform                 1.5.3      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.5.3      Terraform enables you to safely and predictably create, change, and improve infrastructure.
