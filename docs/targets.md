...
ec2-instance-selector     2.3.3      A CLI tool and go library which recommends instance types based on resource criteria like vcpus and memory
...
helm                      3.9.2      The Kubernetes Package Manager
helm2                     2.17.0     The Kubernetes Package Manager
helm3                     3.9.2      The Kubernetes Package Manager
...
terraform-module-versions 3.1.12     CLI tool that checks Terraform code for module updates. Single binary, no dependencies. linux, osx, windows.
...
terragrunt                0.38.6     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
