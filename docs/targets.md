...
argocd                    2.7.0      Declarative GitOpts for Kubernetes
...
cloud-nuke                0.29.7     Tool for wiping an aws account DANGER absolutely do not use in production
cloudflared               2023.4.1   Argo Tunnel client
cloudposse-atlantis       OBSOLETE   Terraform For Teams, enhanced by Cloud Posse
codefresh*                0.82.9     Codefresh CLI
...
spotctl                   0.30.0     A unified CLI to manage your [Spot](https://spot.io/) resources.
...
teleport                  12.2.5     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.45.8     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
