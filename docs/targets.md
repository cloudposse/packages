...
teleport                  17.3.2     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.75.0     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
