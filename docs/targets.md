...
doctl                     1.112.0    A command line tool for DigitalOcean services
...
sentry-cli                2.35.0     A command line utility to work with Sentry.
...
terragrunt                0.67.3     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
