...
doctl                     1.69.0     A command line tool for DigitalOcean services
...
terragrunt                0.35.19    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
