...
codefresh                 0.73.23    Codefresh CLI
...
sentry-cli                1.60.0     A command line utility to work with Sentry.
...
variant2                  0.36.0     Second major version of Variant, a Universal CLI tool that works like a task runner
