...
argocd                    3.1.5      Declarative GitOpts for Kubernetes
assume-role*              0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.35.1     Terraform For Teams
...
cloudflared               2025.8.1   Argo Tunnel client
...
k9s                       0.50.10    Kubernetes CLI To Manage Your Clusters In Style
...
sentry-cli                2.53.0     A command line utility to work with Sentry.
...
spacectl                  1.15.1     [Spacelift.io](https://spacelift.io/) client and CLI
