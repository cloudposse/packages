...
argocd                    2.11.7     Declarative GitOpts for Kubernetes
...
hugo                      0.130.0    The world’s fastest framework for building websites.
...
k3d                       5.7.2      Little helper to run Rancher Lab's k3s in Docker
...
opa                       0.67.0     An open source project to policy-enable your service.
pack                      0.35.0     Create cloud native Buildpacks
...
sentry-cli                2.33.0     A command line utility to work with Sentry.
...
spacectl                  1.1.0      [Spacelift.io](https://spacelift.io/) client and CLI
...
terragrunt                0.64.5     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
yq                        4.44.2     yq is a portable command-line YAML processor
```
