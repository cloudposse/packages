...
hugo                      0.152.0    The world’s fastest framework for building websites.
...
promtool                  3.7.1      Prometheus CLI tool
...
terragrunt                0.91.2     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
