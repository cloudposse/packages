...
terragrunt                0.21.12    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
yq                        3.1.0      yq is a portable command-line YAML processor
```
