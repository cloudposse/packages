...
atmos                     1.4.5      Universal Tool for DevOps and Cloud Automation
...
figurine                  1.1.3      Print your name in style
...
terragrunt                0.36.6     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.25.4     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
yq                        4.24.4     yq is a portable command-line YAML processor
```
