...
lazydocker                0.23.0     The lazier way to manage everything docker
...
terragrunt                0.52.1     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
venona*                   1.10.2     Codefresh runtime-environment agent
