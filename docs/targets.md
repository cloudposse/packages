...
argocd                    2.4.14     Declarative GitOpts for Kubernetes
assume-role               0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.19.9     Terraform For Teams
...
promtool                  2.39.0     Prometheus CLI tool
...
terragrunt                0.39.1     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
yq                        4.28.1     yq is a portable command-line YAML processor
```
