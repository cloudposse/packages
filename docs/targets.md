...
argocd                    2.12.2     Declarative GitOpts for Kubernetes
...
aws-iam-authenticator     0.6.25     A tool to use AWS IAM credentials to authenticate to a Kubernetes cluster
...
doctl                     1.111.0    A command line tool for DigitalOcean services
...
ecspresso                 2.4.0      Ecspresso is a deployment tool for Amazon ECS
...
hcledit                   0.2.13     A command line editor for HCL
...
hugo                      0.133.0    The world’s fastest framework for building websites.
...
opa                       0.67.1     An open source project to policy-enable your service.
...
promtool                  2.54.0     Prometheus CLI tool
...
teleport                  16.1.8     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.66.9     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.54.1     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
vendir                    0.41.0     Easy way to vendor portions of git repos, github releases, helm charts, docker image contents, etc. declaratively.
