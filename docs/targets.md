...
atmos                     1.181.0    Universal Tool for DevOps and Cloud Automation
...
k6                        1.1.0      A modern load testing tool, using Go and JavaScript - https://k6.io
...
promtool                  3.4.2      Prometheus CLI tool
...
terragrunt                0.82.0     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
