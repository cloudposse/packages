...
hugo                      0.123.8    The world’s fastest framework for building websites.
...
popeye                    0.21.0     A Kubernetes cluster resource sanitizer
...
teleport                  15.1.3     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.55.14    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
