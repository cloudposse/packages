...
argocd                    2.10.2     Declarative GitOpts for Kubernetes
assume-role*              0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.27.1     Terraform For Teams
atmos                     1.64.3     Universal Tool for DevOps and Cloud Automation
awless*                   0.1.11     A Mighty CLI for AWS
aws-copilot-cli           1.33.1     Tool for developers to build, release and operate containerized applications on AWS App Runner or Amazon ECS on AWS Fargate.
...
cloudflared               2024.2.1   Argo Tunnel client
...
helm                      3.14.2     The Kubernetes Package Manager
helm2                     2.17.0     The Kubernetes Package Manager
helm3                     3.14.2     The Kubernetes Package Manager
helmfile                  0.144.0    Deploy Kubernetes Helm Charts
htmltest                  0.17.0     :white_check_mark: Test generated HTML for problems
hugo                      0.123.7    The world’s fastest framework for building websites.
infracost                 0.10.33    Cloud cost estimates for Terraform
...
k9s                       0.32.0     Kubernetes CLI To Manage Your Clusters In Style
...
kubectl                   1.29.2     Production-Grade Container Scheduling and Management
...
kubectl-1.26              1.26.14    Production-Grade Container Scheduling and Management (v1.26)
kubectl-1.27              1.27.11    Production-Grade Container Scheduling and Management (v1.27)
kubectl-1.28              1.28.7     Production-Grade Container Scheduling and Management (v1.28)
kubectl-1.29              1.29.2     Production-Grade Container Scheduling and Management (v1.29)
...
opa                       0.62.0     An open source project to policy-enable your service.
pack                      0.33.2     Create cloud native Buildpacks
packer                    1.10.1     Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
pandoc                    3.1.12.2   Universal markup converter
pgmetrics                 1.16.0     Postgres metrics
pluto                     5.19.0     A cli tool to help discover deprecated apiVersions in Kubernetes
popeye                    0.20.4     A Kubernetes cluster resource sanitizer
promtool                  2.50.1     Prometheus CLI tool
...
sentry-cli                2.29.1     A command line utility to work with Sentry.
...
teleport                  15.1.1     Secure Access for Developers that doesn't get in the way.
...
terraform                 1.7.4      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.7.4      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terragrunt                0.55.11    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.49.1     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
velero                    1.13.0     Backup and migrate Kubernetes applications and their persistent volumes
