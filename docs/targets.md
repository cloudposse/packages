...
gitleaks                  8.24.2     Audit git repos for secrets 🔑
...
hugo                      0.146.1    The world’s fastest framework for building websites.
...
terragrunt                0.77.12    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
