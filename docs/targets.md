...
cloudflared               2021.5.10  Argo Tunnel client
...
kubectl-1.19              1.19.11    Production-Grade Container Scheduling and Management (v1.19)
kubectl-1.20              1.20.7     Production-Grade Container Scheduling and Management (v1.19)
...
promtool                  2.27.1     Prometheus CLI tool
...
teleport                  6.2.3      Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.30.3     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
