...
argocd                    2.13.0     Declarative GitOpts for Kubernetes
assume-role*              0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.30.0     Terraform For Teams
atmos                     1.107.0    Universal Tool for DevOps and Cloud Automation
...
aws-iam-authenticator     0.6.27     A tool to use AWS IAM credentials to authenticate to a Kubernetes cluster
...
cloudflared               2024.11.0  Argo Tunnel client
...
doctl                     1.117.0    A command line tool for DigitalOcean services
...
ecspresso                 2.4.3      Ecspresso is a deployment tool for Amazon ECS
...
kops                      1.30.1     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
kubectl                   1.31.2     Production-Grade Container Scheduling and Management
...
kubectl-1.29              1.29.10    Production-Grade Container Scheduling and Management (v1.29)
kubectl-1.30              1.30.6     Production-Grade Container Scheduling and Management (v1.30)
kubectl-1.31              1.31.2     Production-Grade Container Scheduling and Management (v1.31)
...
pack                      0.35.1     Create cloud native Buildpacks
...
promtool                  3.0.0      Prometheus CLI tool
...
sentry-cli                2.38.2     A command line utility to work with Sentry.
...
spacectl                  1.7.0      [Spacelift.io](https://spacelift.io/) client and CLI
...
teleport                  17.0.1     Secure Access for Developers that doesn't get in the way.
...
terraform-config-inspect  0.0.20240801114854+git6714b46f5fe4 A helper library for shallow inspection of Terraform configurations
...
terragrunt                0.68.15    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
thanos                    0.36.1     Highly available Prometheus setup with long term storage capabilities. CNCF Sandbox project.
trivy                     0.57.0     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
yq                        4.44.5     yq is a portable command-line YAML processor
```
