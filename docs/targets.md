...
cloudflared               2022.6.3   Argo Tunnel client
...
gomplate                  3.11.1     A flexible commandline tool for template rendering. Supports lots of local and remote datasources.
...
promtool                  2.36.2     Prometheus CLI tool
...
tflint                    0.38.1     A Pluggable Terraform Linter
...
trivy                     0.29.1     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
