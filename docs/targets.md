...
gitleaks                  8.21.3     Audit git repos for secrets 🔑
...
opa                       0.70.0     An open source project to policy-enable your service.
...
pandoc                    3.6        Universal markup converter
...
teleport                  17.0.5     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.70.4     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
