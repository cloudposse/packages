...
aws-iam-authenticator     0.6.20     A tool to use AWS IAM credentials to authenticate to a Kubernetes cluster
...
doctl                     1.108.0    A command line tool for DigitalOcean services
...
gomplate                  4.0.0      A flexible commandline tool for template rendering. Supports lots of local and remote datasources.
...
hugo                      0.128.0    The world’s fastest framework for building websites.
...
teleport                  16.0.1     Secure Access for Developers that doesn't get in the way.
...
trivy                     0.52.2     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
