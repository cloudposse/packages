...
atmos                     1.122.0    Universal Tool for DevOps and Cloud Automation
...
kubectl                   1.31.4     Production-Grade Container Scheduling and Management
...
spacectl                  1.7.1      [Spacelift.io](https://spacelift.io/) client and CLI
...
teleport                  17.0.4     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.69.9     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
thanos                    0.37.1     Highly available Prometheus setup with long term storage capabilities. CNCF Sandbox project.
