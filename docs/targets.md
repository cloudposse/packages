...
cloudflared               2025.11.0  Argo Tunnel client
...
gitleaks                  8.29.0     Audit git repos for secrets 🔑
...
teleport                  18.3.1     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.93.3     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
