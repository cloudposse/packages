...
argocd                    2.8.0      Declarative GitOpts for Kubernetes
assume-role*              0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.25.0     Terraform For Teams
atmos                     1.44.0     Universal Tool for DevOps and Cloud Automation
...
doctl                     1.98.0     A command line tool for DigitalOcean services
...
hugo                      0.117.0    The world’s fastest framework for building websites.
...
jx                        3.10.95    Jenkins-X
k3d                       5.5.2      Little helper to run Rancher Lab's k3s in Docker
...
kubectl                   1.28.0     Production-Grade Container Scheduling and Management
...
kubectl-1.24              1.24.16    Production-Grade Container Scheduling and Management (v1.24)
kubectl-1.25              1.25.12    Production-Grade Container Scheduling and Management (v1.25)
kubectl-1.26              1.26.7     Production-Grade Container Scheduling and Management (v1.26)
kubectl-1.27              1.27.4     Production-Grade Container Scheduling and Management (v1.27)
kubectl-1.28              1.28.0     Production-Grade Container Scheduling and Management (v1.28)
...
opa                       0.55.0     An open source project to policy-enable your service.
pack                      0.30.0     Create cloud native Buildpacks
packer                    1.9.3      Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
pandoc                    3.1.6.1    Universal markup converter
pgmetrics                 1.15.1     Postgres metrics
pluto                     5.18.2     A cli tool to help discover deprecated apiVersions in Kubernetes
...
sentry-cli                2.20.5     A command line utility to work with Sentry.
...
teleport                  13.3.2     Secure Access for Developers that doesn't get in the way.
...
terraform                 1.5.5      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.5.5      Terraform enables you to safely and predictably create, change, and improve infrastructure.
terraform-config-inspect  0.0.20230808231734+gitf15f31bf62b3 A helper library for shallow inspection of Terraform configurations
...
terragrunt                0.50.4     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.44.1     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
