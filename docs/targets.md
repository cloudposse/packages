...
atmos                     1.168.0    Universal Tool for DevOps and Cloud Automation
...
cloud-nuke                0.39.0     Tool for wiping an aws account DANGER absolutely do not use in production
...
sops                      3.10.0     Secrets management stinks, use some sops!
...
teleport                  17.4.1     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.77.1     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
