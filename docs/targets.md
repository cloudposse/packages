...
argocd                    2.14.3     Declarative GitOpts for Kubernetes
...
teleport                  17.3.0     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.73.16    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
