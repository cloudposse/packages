...
terragrunt                0.33.2     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
yq                        4.13.2     yq is a portable command-line YAML processor
```
