...
atmos                     1.165.1    Universal Tool for DevOps and Cloud Automation
...
terragrunt                0.75.3     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
