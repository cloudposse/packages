...
helmfile                  0.139.6    Deploy Kubernetes Helm Charts
...
jx                        3.2.100    Jenkins-X
k3d                       4.4.3      Little helper to run Rancher Lab's k3s in Docker
...
terraform                 0.15.3     Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-0.15            0.15.3     Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terragrunt                0.29.3     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.18.1     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
yq                        4.9.1      yq is a portable command-line YAML processor
```
