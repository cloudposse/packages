...
minikube                  1.31.0     Run Kubernetes locally
...
teleport                  13.2.2     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.48.3     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
