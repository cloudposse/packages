...
argocd                    2.13.2     Declarative GitOpts for Kubernetes
assume-role*              0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.32.0     Terraform For Teams
atmos                     1.130.0    Universal Tool for DevOps and Cloud Automation
...
aws-iam-authenticator     0.6.29     A tool to use AWS IAM credentials to authenticate to a Kubernetes cluster
...
cilium-cli                0.16.22    CLI to install, manage & troubleshoot Kubernetes clusters running Cilium
cli53                     0.8.23     Command line tool for Amazon Route 53
cloud-nuke                0.38.0     Tool for wiping an aws account DANGER absolutely do not use in production
cloudflared               2024.12.2  Argo Tunnel client
...
doctl                     1.120.0    A command line tool for DigitalOcean services
...
gitleaks                  8.22.0     Audit git repos for secrets 🔑
...
jx                        3.11.2     Jenkins-X
k3d                       5.7.5      Little helper to run Rancher Lab's k3s in Docker
k6                        0.55.2     A modern load testing tool, using Go and JavaScript - https://k6.io
...
kubectl                   1.32.0     Production-Grade Container Scheduling and Management
...
kubectl-1.29              1.29.12    Production-Grade Container Scheduling and Management (v1.29)
kubectl-1.30              1.30.8     Production-Grade Container Scheduling and Management (v1.30)
kubectl-1.31              1.31.4     Production-Grade Container Scheduling and Management (v1.31)
...
minikube                  1.34.0     Run Kubernetes locally
misspell*                 0.3.4      Correct commonly misspelled English words in source files
nomad                     OBSOLETE   Hashicorp nomad
opa                       1.0.0      An open source project to policy-enable your service.
pack                      0.36.1     Create cloud native Buildpacks
...
pandoc                    3.6.1      Universal markup converter
pgmetrics                 1.17.0     Postgres metrics
pluto                     5.20.3     A cli tool to help discover deprecated apiVersions in Kubernetes
popeye                    0.21.5     A Kubernetes cluster resource sanitizer
...
sentry-cli                2.39.1     A command line utility to work with Sentry.
...
sops                      3.9.2      Secrets management stinks, use some sops!
spacectl                  1.8.0      [Spacelift.io](https://spacelift.io/) client and CLI
...
teleport                  17.1.1     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.71.1     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.58.0     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
yq                        4.44.6     yq is a portable command-line YAML processor
```
