...
atmos                     1.116.0    Universal Tool for DevOps and Cloud Automation
...
terragrunt                0.69.8     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
