...
argocd                    3.1.4      Declarative GitOpts for Kubernetes
...
aws-iam-authenticator     0.7.6      A tool to use AWS IAM credentials to authenticate to a Kubernetes cluster
...
doctl                     1.141.0    A command line tool for DigitalOcean services
...
helm                      3.18.6     The Kubernetes Package Manager
helm2                     2.17.0     The Kubernetes Package Manager
helm3                     3.18.6     The Kubernetes Package Manager
...
kubectl                   1.34.0     Production-Grade Container Scheduling and Management
...
kubectl-1.31              1.31.12    Production-Grade Container Scheduling and Management (v1.31)
kubectl-1.32              1.32.8     Production-Grade Container Scheduling and Management (v1.32)
...
teleport                  18.2.0     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.87.0     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
velero                    1.16.2     Backup and migrate Kubernetes applications and their persistent volumes
...
yq                        4.47.1     yq is a portable command-line YAML processor
```
