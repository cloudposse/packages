...
atmos                     1.3.9      Universal Tool for DevOps and Cloud Automation
...
consul                    1.10.4     Hashicorp consul
ctop                      0.7.6      Top-like interface for container metrics
direnv                    2.28.0     Unclutter your .profile
doctl                     1.67.0     A command line tool for DigitalOcean services
...
hcledit                   0.2.1      A command line editor for HCL
...
hugo                      0.89.3     The world’s fastest framework for building websites.
jp                        0.2.1      Command line interface to JMESPath
jq                        1.6.0      Command-line JSON processor
json2hcl                  0.0.6      Convert JSON to HCL, and vice versa
jx                        3.2.217    Jenkins-X
k3d                       5.1.0      Little helper to run Rancher Lab's k3s in Docker
...
kubectl                   1.22.3     Production-Grade Container Scheduling and Management
...
kubectl-1.20              1.20.12    Production-Grade Container Scheduling and Management (v1.19)
...
opa                       0.34.2     An open source project to policy-enable your service.
...
pandoc                    2.16.1     Universal markup converter
...
promtool                  2.31.1     Prometheus CLI tool
...
teleport                  7.3.3      Secure Access for Developers that doesn't get in the way.
...
terraform                 1.0.11     Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.0.11     Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terraform-module-versions 3.1.6      CLI tool that checks Terraform code for module updates. Single binary, no dependencies. linux, osx, windows.
...
terragrunt                0.35.10    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.21.0     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
yq                        4.14.2     yq is a portable command-line YAML processor
```
