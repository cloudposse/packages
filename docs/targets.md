...
argocd                    3.0.6      Declarative GitOpts for Kubernetes
assume-role*              0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.34.0     Terraform For Teams
atmos                     1.179.0    Universal Tool for DevOps and Cloud Automation
...
cilium-cli                0.18.4     CLI to install, manage & troubleshoot Kubernetes clusters running Cilium
...
gitleaks                  8.27.2     Audit git repos for secrets 🔑
...
promtool                  3.4.1      Prometheus CLI tool
...
spacectl                  1.14.2     [Spacelift.io](https://spacelift.io/) client and CLI
...
teleport                  17.5.1     Secure Access for Developers that doesn't get in the way.
...
terraform-module-versions 3.3.11     CLI tool that checks Terraform code for module updates. Single binary, no dependencies.
...
terragrunt                0.81.3     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
