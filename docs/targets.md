...
atmos                     1.109.0    Universal Tool for DevOps and Cloud Automation
...
codefresh*                0.88.2     Codefresh CLI
...
doctl                     1.119.1    A command line tool for DigitalOcean services
...
hugo                      0.139.2    The world’s fastest framework for building websites.
...
kubectl                   1.31.3     Production-Grade Container Scheduling and Management
...
kubectl-1.30              1.30.7     Production-Grade Container Scheduling and Management (v1.30)
kubectl-1.31              1.31.3     Production-Grade Container Scheduling and Management (v1.31)
...
sentry-cli                2.39.0     A command line utility to work with Sentry.
...
teleport                  17.0.2     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.69.1     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
thanos                    0.37.0     Highly available Prometheus setup with long term storage capabilities. CNCF Sandbox project.
