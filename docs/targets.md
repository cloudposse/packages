...
promtool                  3.9.1      Prometheus CLI tool
...
sentry-cli                3.0.2      A command line utility to work with Sentry.
...
terragrunt                0.97.1     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
