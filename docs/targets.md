...
atmos                     1.34.2     Universal Tool for DevOps and Cloud Automation
...
cloud-nuke                0.30.0     Tool for wiping an aws account DANGER absolutely do not use in production
cloudflared               2023.5.0   Argo Tunnel client
cloudposse-atlantis       OBSOLETE   Terraform For Teams, enhanced by Cloud Posse
codefresh*                0.84.0     Codefresh CLI
conftest                  0.42.0     Test your configuration files using Open Policy Agent
...
helm3                     3.11.3     The Kubernetes Package Manager
...
infracost                 0.10.21    Cloud cost estimates for Terraform
...
teleport                  12.3.2     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.45.10    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
