...
atmos                     1.4.19     Universal Tool for DevOps and Cloud Automation
...
cloudflared               2022.5.3   Argo Tunnel client
...
hugo                      0.100.1    The world’s fastest framework for building websites.
infracost                 0.10.1     Cloud cost estimates for Terraform
...
promtool                  2.36.0     Prometheus CLI tool
...
spacectl                  0.10.0     [Spacelift.io](https://spacelift.io/) client and CLI
...
teleport                  9.3.2      Secure Access for Developers that doesn't get in the way.
...
terraform-1               1.2.2      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
tflint                    0.37.0     A Pluggable Terraform Linter
