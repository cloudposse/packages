...
terraform                 1.5.0      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.5.0      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
trivy                     0.42.1     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
