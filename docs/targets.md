...
atmos                     1.186.0    Universal Tool for DevOps and Cloud Automation
...
cloudflared               2025.8.0   Argo Tunnel client
...
doctl                     1.138.0    A command line tool for DigitalOcean services
...
jx                        3.16.19    Jenkins-X
k3d                       5.8.3      Little helper to run Rancher Lab's k3s in Docker
k6                        1.2.1      A modern load testing tool, using Go and JavaScript - https://k6.io
...
kops                      1.33.0     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
pluto                     5.22.3     A cli tool to help discover deprecated apiVersions in Kubernetes
...
sentry-cli                2.51.1     A command line utility to work with Sentry.
...
spacectl                  1.15.0     [Spacelift.io](https://spacelift.io/) client and CLI
...
teleport                  18.1.4     Secure Access for Developers that doesn't get in the way.
