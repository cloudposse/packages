...
atmos                     1.155.0    Universal Tool for DevOps and Cloud Automation
...
gitleaks                  8.23.2     Audit git repos for secrets 🔑
...
hugo                      0.142.0    The world’s fastest framework for building websites.
...
opa                       1.0.1      An open source project to policy-enable your service.
...
popeye                    0.21.7     A Kubernetes cluster resource sanitizer
...
terragrunt                0.72.4     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
