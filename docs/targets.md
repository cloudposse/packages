...
argocd                    3.1.3      Declarative GitOpts for Kubernetes
...
terragrunt                0.86.2     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
