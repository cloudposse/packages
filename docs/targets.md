...
hugo                      0.105.0    The world’s fastest framework for building websites.
...
promtool                  2.40.1     Prometheus CLI tool
...
sentry-cli                2.8.1      A command line utility to work with Sentry.
...
teleport                  11.0.1     Secure Access for Developers that doesn't get in the way.
...
terraform                 1.3.4      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.3.4      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
yq                        4.30.1     yq is a portable command-line YAML processor
```
