...
atmos                     1.52.0     Universal Tool for DevOps and Cloud Automation
...
ecspresso                 2.3.1      Ecspresso is a deployment tool for Amazon ECS
...
k9s                       0.30.8     Kubernetes CLI To Manage Your Clusters In Style
...
sentry-cli                2.23.2     A command line utility to work with Sentry.
...
teleport                  14.3.0     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.54.12    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
tflint                    0.50.0     A Pluggable Terraform Linter
...
trivy                     0.48.2     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
