...
atmos                     1.4.22     Universal Tool for DevOps and Cloud Automation
...
k9s                       0.25.20    Kubernetes CLI To Manage Your Clusters In Style
...
minikube                  1.26.0     Run Kubernetes locally
...
pluto                     5.9.0      A cli tool to help discover deprecated apiVersions in Kubernetes
...
rbac-lookup               0.8.4      Find Kubernetes roles and cluster roles bound to any user, service account, or group name.
...
teleport                  9.3.7      Secure Access for Developers that doesn't get in the way.
...
terraform                 1.2.4      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.2.4      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terraform-module-versions 3.1.11     CLI tool that checks Terraform code for module updates. Single binary, no dependencies. linux, osx, windows.
...
terragrunt                0.38.3     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.29.2     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
yq                        4.25.3     yq is a portable command-line YAML processor
```
