...
atmos                     1.96.0     Universal Tool for DevOps and Cloud Automation
...
opa                       0.69.0     An open source project to policy-enable your service.
...
sentry-cli                2.38.0     A command line utility to work with Sentry.
...
terragrunt                0.68.5     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.56.2     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
