...
argocd                    2.10.8     Declarative GitOpts for Kubernetes
assume-role*              0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.27.3     Terraform For Teams
atmos                     1.70.0     Universal Tool for DevOps and Cloud Automation
awless*                   0.1.11     A Mighty CLI for AWS
aws-copilot-cli           1.33.3     Tool for developers to build, release and operate containerized applications on AWS App Runner or Amazon ECS on AWS Fargate.
...
cloudflared               2024.4.1   Argo Tunnel client
...
github-status-updater     0.9.1      Command line utility for updating GitHub commit statuses and enabling required status checks for pull requests
...
kubectl                   1.30.0     Production-Grade Container Scheduling and Management
...
kubectl-1.27              1.27.13    Production-Grade Container Scheduling and Management (v1.27)
kubectl-1.28              1.28.9     Production-Grade Container Scheduling and Management (v1.28)
kubectl-1.29              1.29.4     Production-Grade Container Scheduling and Management (v1.29)
...
minikube                  1.33.0     Run Kubernetes locally
misspell*                 0.3.4      Correct commonly misspelled English words in source files
nomad                     OBSOLETE   Hashicorp nomad
opa                       0.64.1     An open source project to policy-enable your service.
pack                      0.33.2     Create cloud native Buildpacks
packer                    1.10.3     Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
pandoc                    3.1.13     Universal markup converter
...
promtool                  2.51.2     Prometheus CLI tool
...
teleport                  15.2.5     Secure Access for Developers that doesn't get in the way.
...
terraform                 1.8.2      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.8.2      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terragrunt                0.57.12    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.50.4     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
vault                     1.16.2     Hashicorp vault
velero                    1.13.2     Backup and migrate Kubernetes applications and their persistent volumes
vendir                    0.40.1     Easy way to vendor portions of git repos, github releases, helm charts, docker image contents, etc. declaratively.
