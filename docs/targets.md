...
codefresh                 0.75.10    Codefresh CLI
...
pluto                     4.1.0      A cli tool to help discover deprecated apiVersions in Kubernetes
...
sentry-cli                1.64.0     A command line utility to work with Sentry.
...
teleport                  6.1.1      Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.28.21    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
thanos                    0.19.0     Highly available Prometheus setup with long term storage capabilities. CNCF Sandbox project.
trivy                     0.16.0     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
turf                      0.15.0     Turf is Cloud Posse's command-line automation helper.
...
vendir                    0.18.0      Easy way to vendor portions of git repos, github releases, helm charts, docker image contents, etc. declaratively.
