...
atmos                     1.180.0    Universal Tool for DevOps and Cloud Automation
...
terragrunt                0.81.6     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
