...
argocd                    2.14.9     Declarative GitOpts for Kubernetes
assume-role*              0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.34.0     Terraform For Teams
atmos                     1.170.0    Universal Tool for DevOps and Cloud Automation
...
aws-iam-authenticator     0.6.31     A tool to use AWS IAM credentials to authenticate to a Kubernetes cluster
...
ecspresso                 2.4.6      Ecspresso is a deployment tool for Amazon ECS
...
gitleaks                  8.24.3     Audit git repos for secrets 🔑
go-jsonnet                0.20.0     This an implementation of Jsonnet in pure Go.
gomplate                  4.3.1      A flexible commandline tool for template rendering. Supports lots of local and remote datasources.
...
hugo                      0.146.3    The world’s fastest framework for building websites.
...
jx                        3.11.77    Jenkins-X
k3d                       5.8.3      Little helper to run Rancher Lab's k3s in Docker
k6                        0.58.0     A modern load testing tool, using Go and JavaScript - https://k6.io
k9s                       0.50.3     Kubernetes CLI To Manage Your Clusters In Style
...
kops                      1.31.0     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
kubectl                   1.32.3     Production-Grade Container Scheduling and Management
...
kubectl-1.31              1.31.7     Production-Grade Container Scheduling and Management (v1.31)
kubectl-1.32              1.32.3     Production-Grade Container Scheduling and Management (v1.32)
...
opa                       1.3.0      An open source project to policy-enable your service.
...
pandoc                    3.6.4      Universal markup converter
pgmetrics                 1.17.1     Postgres metrics
pluto                     5.21.3     A cli tool to help discover deprecated apiVersions in Kubernetes
popeye                    0.22.1     A Kubernetes cluster resource sanitizer
promtool                  3.2.1      Prometheus CLI tool
...
sentry-cli                2.43.0     A command line utility to work with Sentry.
...
sops                      3.10.1     Secrets management stinks, use some sops!
spacectl                  1.11.0     [Spacelift.io](https://spacelift.io/) client and CLI
...
teleport                  17.4.3     Secure Access for Developers that doesn't get in the way.
...
terraform-module-versions 3.3.8      CLI tool that checks Terraform code for module updates. Single binary, no dependencies.
...
terragrunt                0.77.17    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
tflint                    0.56.0     A Pluggable Terraform Linter
...
tfsec                     1.28.13    (DEPRECATED: use Trivy instead) Security scanner for your Terraform code
thanos                    0.38.0     Highly available Prometheus setup with long term storage capabilities. CNCF Sandbox project.
trivy                     0.61.0     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
vendir                    0.43.2     Easy way to vendor portions of git repos, github releases, helm charts, docker image contents, etc. declaratively.
...
yq                        4.45.1     yq is a portable command-line YAML processor
```
