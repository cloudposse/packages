...
k9s                       0.25.7     Kubernetes CLI To Manage Your Clusters In Style
...
terragrunt                0.35.13    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.21.1     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
yq                        4.15.1     yq is a portable command-line YAML processor
```
