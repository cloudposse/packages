...
doctl                     1.82.0     A command line tool for DigitalOcean services
...
spacectl                  0.13.0     [Spacelift.io](https://spacelift.io/) client and CLI
...
teleport                  10.2.6     Secure Access for Developers that doesn't get in the way.
...
terraform                 1.3.1      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
