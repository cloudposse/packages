...
cloudflared               2022.5.0   Argo Tunnel client
...
jx                        3.2.336    Jenkins-X
k3d                       5.4.1      Little helper to run Rancher Lab's k3s in Docker
k6                        0.38.1     A modern load testing tool, using Go and JavaScript - https://k6.io
...
kops                      1.23.1     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
lazydocker                0.17.1     The lazier way to manage everything docker
...
teleport                  9.2.1      Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.36.10    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
tfsec                     1.20.2     Security scanner for your Terraform code
