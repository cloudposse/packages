...
hugo                      0.154.3    The world’s fastest framework for building websites.
...
k6                        1.5.0      A modern load testing tool, using Go and JavaScript - https://k6.io
...
opa                       1.12.2     An open source project to policy-enable your service.
...
spacectl                  1.17.1     [Spacelift.io](https://spacelift.io/) client and CLI
