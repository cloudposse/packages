...
slack-notifier            0.7.0      Command line utility to send messages with attachments to Slack channels via Incoming Webhooks
...
teleport                  14.3.3     Secure Access for Developers that doesn't get in the way.
