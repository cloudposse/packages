...
atmos                     1.2.0      Universal Tool for DevOps and Cloud Automation
...
cloudflared               2021.9.2   Argo Tunnel client
...
teleport                  7.2.0      Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.34.1     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
yq                        4.13.3     yq is a portable command-line YAML processor
```
