...
cloudflared               2022.10.1  Argo Tunnel client
...
doctl                     1.84.0     A command line tool for DigitalOcean services
...
terragrunt                0.39.2     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
