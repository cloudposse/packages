...
argocd                    2.8.6      Declarative GitOpts for Kubernetes
assume-role*              0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.26.0     Terraform For Teams
atmos                     1.47.0     Universal Tool for DevOps and Cloud Automation
...
hugo                      0.120.2    The world’s fastest framework for building websites.
...
terraform                 1.6.2      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.6.2      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terragrunt                0.53.0     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.46.1     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
