...
atmos                     1.64.0     Universal Tool for DevOps and Cloud Automation
...
consul                    1.17.3     Hashicorp consul
...
hugo                      0.123.2    The world’s fastest framework for building websites.
...
popeye                    0.20.3     A Kubernetes cluster resource sanitizer
promtool                  2.50.0     Prometheus CLI tool
...
terragrunt                0.55.9     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
yq                        4.41.1     yq is a portable command-line YAML processor
```
