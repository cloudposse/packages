...
atlantis                  0.23.5     Terraform For Teams
...
codefresh*                0.84.1     Codefresh CLI
...
doctl                     1.95.0     A command line tool for DigitalOcean services
...
k3d                       5.5.0      Little helper to run Rancher Lab's k3s in Docker
...
kubectl                   1.27.1     Production-Grade Container Scheduling and Management
...
sentry-cli                2.17.5     A command line utility to work with Sentry.
...
teleport                  13.0.0     Secure Access for Developers that doesn't get in the way.
...
terraform-config-inspect  0.0.20230413234026+gitf1617e8a5fcc A helper library for shallow inspection of Terraform configurations
...
terragrunt                0.45.11    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
