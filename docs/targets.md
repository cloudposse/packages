...
argocd                    2.6.1      Declarative GitOpts for Kubernetes
assume-role               0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.22.3     Terraform For Teams
atmos                     1.28.0     Universal Tool for DevOps and Cloud Automation
...
codefresh                 0.82.1     Codefresh CLI
...
opa                       0.49.0     An open source project to policy-enable your service.
...
pluto                     5.13.3     A cli tool to help discover deprecated apiVersions in Kubernetes
popeye                    0.11.0     A Kubernetes cluster resource sanitizer
...
spotctl                   0.27.0     A unified CLI to manage your [Spot](https://spot.io/) resources.
...
teleport                  12.0.1     Secure Access for Developers that doesn't get in the way.
...
terraform                 1.3.8      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.3.8      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terragrunt                0.43.2     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.37.2     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
