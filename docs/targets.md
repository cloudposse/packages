...
argocd                    1.3.6      Declarative GitOpts for Kubernetes
...
terragrunt                0.21.9     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
