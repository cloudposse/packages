...
argocd                    2.6.6      Declarative GitOpts for Kubernetes
...
aws-vault                 7.1.1      A vault for securely storing and accessing AWS credentials in development environments
...
sentry-cli                2.15.1     A command line utility to work with Sentry.
...
terraform-1               1.4.2      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
venona                    1.9.12     Codefresh runtime-environment agent
