...
argocd                    2.14.10    Declarative GitOpts for Kubernetes
assume-role*              0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.34.0     Terraform For Teams
atmos                     1.171.0    Universal Tool for DevOps and Cloud Automation
...
aws-iam-authenticator     0.7.1      A tool to use AWS IAM credentials to authenticate to a Kubernetes cluster
...
hugo                      0.146.5    The world’s fastest framework for building websites.
...
promtool                  3.3.0      Prometheus CLI tool
...
teleport                  17.4.5     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.77.20    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.61.1     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
