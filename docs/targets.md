...
opa                       0.64.0     An open source project to policy-enable your service.
...
terragrunt                0.57.9     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
