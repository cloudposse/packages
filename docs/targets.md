...
k9s                       0.30.3     Kubernetes CLI To Manage Your Clusters In Style
...
sentry-cli                2.23.1     A command line utility to work with Sentry.
...
terragrunt                0.54.11    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
