...
teleport                  17.2.7     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.73.7     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
