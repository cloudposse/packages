...
atmos                     1.4.7      Universal Tool for DevOps and Cloud Automation
...
conftest                  0.30.1     Test your configuration files using Open Policy Agent
consul                    1.11.5     Hashicorp consul
...
kops                      1.23.0     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
kubectl                   1.23.5     Production-Grade Container Scheduling and Management
...
kubectl-1.21              1.21.11    Production-Grade Container Scheduling and Management (v1.21)
...
terraform                 1.1.8      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.1.8      Terraform enables you to safely and predictably create, change, and improve infrastructure.
