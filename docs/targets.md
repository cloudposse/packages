...
argocd                    3.1.6      Declarative GitOpts for Kubernetes
assume-role*              0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.36.0     Terraform For Teams
atmos                     1.190.0    Universal Tool for DevOps and Cloud Automation
...
aws-iam-authenticator     0.7.7      A tool to use AWS IAM credentials to authenticate to a Kubernetes cluster
...
ecspresso                 2.6.0      Ecspresso is a deployment tool for Amazon ECS
...
gosu                      1.18.0     Simple Go-based setuid+setgid+setgroups+exec
...
hugo                      0.150.0    The world’s fastest framework for building websites.
...
jx                        3.16.24    Jenkins-X
k3d                       5.8.3      Little helper to run Rancher Lab's k3s in Docker
k6                        1.2.3      A modern load testing tool, using Go and JavaScript - https://k6.io
k9s                       0.50.12    Kubernetes CLI To Manage Your Clusters In Style
...
kops                      1.33.1     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
promtool                  3.5.0      Prometheus CLI tool
...
sentry-cli                2.54.0     A command line utility to work with Sentry.
...
spacectl                  1.15.2     [Spacelift.io](https://spacelift.io/) client and CLI
...
teleport                  18.2.1     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.87.4     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.66.0     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
yq                        4.47.2     yq is a portable command-line YAML processor
```
