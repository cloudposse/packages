...
argocd                    1.8.2      Declarative GitOpts for Kubernetes
assume-role               0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.16.0     Terraform For Teams
...
doctl                     1.54.1     A command line tool for DigitalOcean services
...
fetch                     0.3.12     fetch makes it easy to download files, folders, and release assets from a specific public git commit, branch, or tag
figurine                  1.0.1      Print your name in style
fzf                       0.23.1     A command-line fuzzy finder
gh                        1.4.0      The GitHub CLI
...
helm                      3.5.0      The Kubernetes Package Manager
helm2                     2.17.0     The Kubernetes Package Manager
helm3                     3.5.0      The Kubernetes Package Manager
helmfile                  0.137.0    Deploy Kubernetes Helm Charts
...
kubectl                   1.20.1     Production-Grade Container Scheduling and Management
...
kubectl-1.17              1.17.16    Production-Grade Container Scheduling and Management (v1.17)
kubectl-1.18              1.18.14    Production-Grade Container Scheduling and Management (v1.18)
kubectl-1.19              1.19.6     Production-Grade Container Scheduling and Management (v1.19)
...
minikube                  1.16.0     Run Kubernetes locally
...
pandoc                    2.11.3     Universal markup converter
pgmetrics                 1.10.4     Postgres metrics
...
promtool                  2.24.0     Prometheus CLI tool
...
teleport                  5.1.0      Secure Access for Developers that doesn't get in the way.
...
terraform                 0.14.4     Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-0.14            0.14.4     Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terragrunt                0.27.1     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
yq                        4.0.0      yq is a portable command-line YAML processor
```
