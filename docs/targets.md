...
argocd                    2.0.4      Declarative GitOpts for Kubernetes
assume-role               0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.17.2     Terraform For Teams
atmos                     0.21.0     Universal Tool for DevOps and Cloud Automation
...
cfssl                     1.6.0      Cloudflare's PKI and TLS toolkit
cfssljson                 1.6.0      Cloudflare's PKI and TLS toolkit json parser
chamber                   2.10.1     CLI for managing secrets
cli53                     0.8.18     Command line tool for Amazon Route 53
cloudflared               2021.6.0   Argo Tunnel client
cloudposse-atlantis       0.9.0.3    Terraform For Teams, enhanced by Cloud Posse
codefresh                 0.75.28    Codefresh CLI
conftest                  0.25.0     Test your configuration files using Open Policy Agent
consul                    1.10.0     Hashicorp consul
ctop                      0.7.6      Top-like interface for container metrics
direnv                    2.28.0     Unclutter your .profile
doctl                     1.61.0     A command line tool for DigitalOcean services
...
gh                        1.12.1     The GitHub CLI
ghr                       0.14.0     Upload multiple artifacts to GitHub Releases in parallel
github-commenter          0.9.0      Command line utility for creating GitHub comments on Commits, Pull Request Reviews or Issues
...
grpcurl                   1.8.1      Like cURL, but for gRPC: Command-line tool for interacting with gRPC servers
helm                      3.6.2      The Kubernetes Package Manager
helm2                     2.17.0     The Kubernetes Package Manager
helm3                     3.6.2      The Kubernetes Package Manager
helmfile                  0.139.9    Deploy Kubernetes Helm Charts
htmltest                  0.14.0     :white_check_mark: Test generated HTML for problems
hugo                      0.84.3     The world’s fastest framework for building websites.
jp                        0.1.3      Command line interface to JMESPath
jq                        1.6.0      Command-line JSON processor
json2hcl                  0.0.6      Convert JSON to HCL, and vice versa
jx                        3.2.156    Jenkins-X
k3d                       4.4.6      Little helper to run Rancher Lab's k3s in Docker
k6                        0.33.0     A modern load testing tool, using Go and JavaScript - https://k6.io
...
kops                      1.20.2     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
kubectl                   1.21.2     Production-Grade Container Scheduling and Management
...
minikube                  1.21.0     Run Kubernetes locally
misspell                  0.3.4      Correct commonly misspelled English words in source files
nomad                     OBSOLETE   Hashicorp nomad
opa                       0.30.0     An open source project to policy-enable your service.
...
popeye                    0.9.3      A Kubernetes cluster resource sanitizer
promtool                  2.28.0     Prometheus CLI tool
...
saml2aws                  2.31.0     CLI tool which enables you to login and retrieve AWS temporary credentials using a SAML IDP
scenery                   0.1.5      A Terraform plan output prettifier
sentinel                  OBSOLETE   Hashicorp sentinel
sentry-cli                1.66.0     A command line utility to work with Sentry.
shellcheck                0.7.2      ShellCheck, a static analysis tool for shell scripts
shfmt                     3.3.0      A shell parser, formatter and interpreter (POSIX/Bash/mksh)
...
spacectl                  0.6.0      [Spacelift.io](https://spacelift.io/) client and CLI
...
teleport                  6.2.6      Secure Access for Developers that doesn't get in the way.
...
teleport-4.4              4.4.10     Privileged access management for elastic infrastructure.
teleport-5.0              5.0.2      Secure Access for Developers that doesn't get in the way.
terraform                 1.0.1      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.0.1      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terraform-docs            0.14.1     Generate docs from terraform modules
...
terragrunt                0.31.0     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.18.3     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
vault                     1.7.3      Hashicorp vault
vendir                    0.21.1      Easy way to vendor portions of git repos, github releases, helm charts, docker image contents, etc. declaratively.
venona                    1.6.6      Codefresh runtime-environment agent
vert                      0.1.0      Simple CLI for comparing two or more versions
yajsv                     1.4.0      Yet Another JSON Schema Validator [CLI]
yq                        4.9.6      yq is a portable command-line YAML processor
```
