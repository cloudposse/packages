...
teleport                  15.3.1     Secure Access for Developers that doesn't get in the way.
...
terraform-config-inspect  0.0.20240508105306+git75f2724ffd72 A helper library for shallow inspection of Terraform configurations
