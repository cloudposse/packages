...
argocd                    3.0.1      Declarative GitOpts for Kubernetes
assume-role*              0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.34.0     Terraform For Teams
atmos                     1.175.0    Universal Tool for DevOps and Cloud Automation
...
aws-iam-authenticator     0.7.2      A tool to use AWS IAM credentials to authenticate to a Kubernetes cluster
...
chamber                   3.1.2      CLI for managing secrets
cilium-cli                0.18.3     CLI to install, manage & troubleshoot Kubernetes clusters running Cilium
cli53                     0.8.24     Command line tool for Amazon Route 53
cloud-nuke                0.40.0     Tool for wiping an aws account DANGER absolutely do not use in production
cloudflared               2025.5.0   Argo Tunnel client
cloudposse-atlantis       OBSOLETE   Terraform For Teams, enhanced by Cloud Posse
codefresh                 0.88.6     Codefresh CLI
conftest                  0.60.0     Test your configuration files using Open Policy Agent
consul                    1.16.4     Hashicorp consul
ctop                      0.7.7      Top-like interface for container metrics
direnv                    2.36.0     Unclutter your .profile
doctl                     1.127.0    A command line tool for DigitalOcean services
...
ecspresso                 2.5.0      Ecspresso is a deployment tool for Amazon ECS
...
gitleaks                  8.26.0     Audit git repos for secrets 🔑
...
jx                        3.11.81    Jenkins-X
k3d                       5.8.3      Little helper to run Rancher Lab's k3s in Docker
k6                        1.0.0      A modern load testing tool, using Go and JavaScript - https://k6.io
k9s                       0.50.6     Kubernetes CLI To Manage Your Clusters In Style
katafygio                 0.8.3      K8s continuous backup to git
kfctl*                    1.2.0      Machine Learning Toolkit for Kubernetes
kind                      0.28.0     A tool for running local Kubernetes clusters using Docker
kops                      1.32.0     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
kubectl                   1.33.1     Production-Grade Container Scheduling and Management
...
kubectl-1.30              1.30.13    Production-Grade Container Scheduling and Management (v1.30)
kubectl-1.31              1.31.9     Production-Grade Container Scheduling and Management (v1.31)
kubectl-1.32              1.32.5     Production-Grade Container Scheduling and Management (v1.32)
...
minikube                  1.35.0     Run Kubernetes locally
misspell*                 0.3.4      Correct commonly misspelled English words in source files
nomad                     OBSOLETE   Hashicorp nomad
opa                       1.4.2      An open source project to policy-enable your service.
pack                      0.37.0     Create cloud native Buildpacks
...
pandoc                    3.7        Universal markup converter
pgmetrics                 1.17.1     Postgres metrics
pluto                     5.21.4     A cli tool to help discover deprecated apiVersions in Kubernetes
popeye                    0.22.1     A Kubernetes cluster resource sanitizer
promtool                  3.3.1      Prometheus CLI tool
...
sentry-cli                2.45.0     A command line utility to work with Sentry.
shellcheck                0.10.0     ShellCheck, a static analysis tool for shell scripts
shfmt                     3.11.0     A shell parser, formatter and interpreter (POSIX/Bash/mksh)
slack-notifier            0.10.0     Command line utility to send messages with attachments to Slack channels via Incoming Webhooks
sops                      3.10.2     Secrets management stinks, use some sops!
spacectl                  1.13.0     [Spacelift.io](https://spacelift.io/) client and CLI
...
stern                     1.32.0     ⎈ Multi pod and container log tailing for Kubernetes
sudosh                    0.3.0      Shell wrapper to run a login shell with `sudo` as the current user for the purpose of audit logging
teleport                  17.4.8     Secure Access for Developers that doesn't get in the way.
...
terraform-docs            0.20.0     Generate docs from terraform modules
terraform-module-versions 3.3.10     CLI tool that checks Terraform code for module updates. Single binary, no dependencies.
...
terragrunt                0.78.4     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
tflint                    0.57.0     A Pluggable Terraform Linter
...
thanos                    0.38.0     Highly available Prometheus setup with long term storage capabilities. CNCF Sandbox project.
trivy                     0.62.1     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
velero                    1.16.0     Backup and migrate Kubernetes applications and their persistent volumes
vendir                    0.44.0     Easy way to vendor portions of git repos, github releases, helm charts, docker image contents, etc. declaratively.
...
yq                        4.45.4     yq is a portable command-line YAML processor
```
