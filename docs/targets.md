...
atmos                     1.34.0     Universal Tool for DevOps and Cloud Automation
...
cloud-nuke                0.29.5     Tool for wiping an aws account DANGER absolutely do not use in production
cloudflared               2023.4.1   Argo Tunnel client
cloudposse-atlantis       OBSOLETE   Terraform For Teams, enhanced by Cloud Posse
codefresh*                0.82.7     Codefresh CLI
...
sentry-cli                2.17.3     A command line utility to work with Sentry.
...
slack-notifier            0.5.0      Command line utility to send messages with attachments to Slack channels via Incoming Webhooks
...
teleport                  12.2.3     Secure Access for Developers that doesn't get in the way.
...
terraform                 1.4.5      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.4.5      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
tflint                    0.46.0     A Pluggable Terraform Linter
