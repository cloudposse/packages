...
cilium-cli                0.16.13    CLI to install, manage & troubleshoot Kubernetes clusters running Cilium
...
terraform-config-inspect  0.0.20240701073647+git9fc3669f7553 A helper library for shallow inspection of Terraform configurations
...
terragrunt                0.64.4     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
