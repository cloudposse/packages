...
atmos                     1.4.12     Universal Tool for DevOps and Cloud Automation
...
jx                        3.2.327    Jenkins-X
k3d                       5.4.1      Little helper to run Rancher Lab's k3s in Docker
k6                        0.38.0     A modern load testing tool, using Go and JavaScript - https://k6.io
...
pack                      0.25.0     Create cloud native Buildpacks
...
tflint                    0.36.0     A Pluggable Terraform Linter
...
tfsec                     1.19.1     Security scanner for your Terraform code
