...
pandoc                    3.1.10     Universal markup converter
...
teleport                  14.2.2     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.54.1     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
