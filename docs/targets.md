...
atmos                     1.194.1    Universal Tool for DevOps and Cloud Automation
...
doctl                     1.145.0    A command line tool for DigitalOcean services
...
hugo                      0.151.2    The world’s fastest framework for building websites.
...
k9s                       0.50.15    Kubernetes CLI To Manage Your Clusters In Style
...
pandoc                    3.8.2      Universal markup converter
...
sentry-cli                2.56.1     A command line utility to work with Sentry.
...
terragrunt                0.91.1     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
