...
argocd                    2.5.6      Declarative GitOpts for Kubernetes
assume-role               0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.22.2     Terraform For Teams
atmos                     1.23.0     Universal Tool for DevOps and Cloud Automation
...
helm                      3.10.3     The Kubernetes Package Manager
...
kubectl                   1.26.0     Production-Grade Container Scheduling and Management
...
kubectl-1.23              1.23.15    Production-Grade Container Scheduling and Management (v1.23)
kubectl-1.24              1.24.9     Production-Grade Container Scheduling and Management (v1.24)
kubectl-1.25              1.25.5     Production-Grade Container Scheduling and Management (v1.25)
...
spacectl                  0.17.2     [Spacelift.io](https://spacelift.io/) client and CLI
...
teleport                  11.2.1     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.42.8     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
