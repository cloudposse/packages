...
atmos                     1.25.0     Universal Tool for DevOps and Cloud Automation
...
terraform-config-inspect  0.0.20221020162138+git81db043ad408 A helper library for shallow inspection of Terraform configurations
...
terragrunt                0.43.1     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
