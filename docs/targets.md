...
pluto                     5.5.3      A cli tool to help discover deprecated apiVersions in Kubernetes
...
tfsec                     1.8.0      Security scanner for your Terraform code
...
yq                        4.22.1     yq is a portable command-line YAML processor
```
