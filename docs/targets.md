...
sentry-cli                2.30.5     A command line utility to work with Sentry.
...
teleport                  15.1.10    Secure Access for Developers that doesn't get in the way.
...
trivy                     0.50.1     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
