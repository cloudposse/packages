...
codefresh                 0.75.29    Codefresh CLI
...
sentry-cli                1.67.1     A command line utility to work with Sentry.
...
terraform                 1.0.2      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.0.2      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
yq                        4.9.8      yq is a portable command-line YAML processor
```
