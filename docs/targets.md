...
atmos                     1.60.0     Universal Tool for DevOps and Cloud Automation
...
cloudflared               2024.2.0   Argo Tunnel client
...
helm                      3.14.0     The Kubernetes Package Manager
...
k9s                       0.31.8     Kubernetes CLI To Manage Your Clusters In Style
katafygio                 0.8.3      K8s continuous backup to git
kfctl*                    1.2.0      Machine Learning Toolkit for Kubernetes
kind                      0.21.0     A tool for running local Kubernetes clusters using Docker
...
kubectl                   1.29.1     Production-Grade Container Scheduling and Management
...
kubectl-1.26              1.26.13    Production-Grade Container Scheduling and Management (v1.26)
kubectl-1.27              1.27.10    Production-Grade Container Scheduling and Management (v1.27)
kubectl-1.28              1.28.6     Production-Grade Container Scheduling and Management (v1.28)
kubectl-1.29              1.29.1     Production-Grade Container Scheduling and Management (v1.29)
...
pack                      0.33.1     Create cloud native Buildpacks
...
popeye                    0.11.3     A Kubernetes cluster resource sanitizer
promtool                  2.49.1     Prometheus CLI tool
...
teleport                  15.0.1     Secure Access for Developers that doesn't get in the way.
...
terraform                 1.7.3      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.7.3      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terragrunt                0.55.2     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
thanos                    0.34.0     Highly available Prometheus setup with long term storage capabilities. CNCF Sandbox project.
...
yq                        4.40.7     yq is a portable command-line YAML processor
```
