...
argocd                    1.7.9      Declarative GitOpts for Kubernetes
...
doctl                     1.52.0     A command line tool for DigitalOcean services
...
k3d                       3.2.1      Little helper to run Rancher Lab's k3s in Docker
k6                        0.29.0     A modern load testing tool, using Go and JavaScript - https://k6.io
k9s                       0.23.10    Kubernetes CLI To Manage Your Clusters In Style
katafygio                 0.8.1      K8s continuous backup to git
kfctl                     1.1.0      Machine Learning Toolkit for Kubernetes
...
kubectl                   1.19.4     Production-Grade Container Scheduling and Management
...
kubectl-1.18              1.18.12    Production-Grade Container Scheduling and Management (v1.18)
kubectl-1.19              1.19.4     Production-Grade Container Scheduling and Management (v1.19)
...
teleport-5.0              5.0.0-rc.2 Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.26.4     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
