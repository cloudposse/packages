...
atmos                     1.166.0    Universal Tool for DevOps and Cloud Automation
...
terragrunt                0.76.3     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
