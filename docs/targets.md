...
terraform-1               1.4.0      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terragrunt                0.44.5     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
