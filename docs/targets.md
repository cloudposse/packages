...
argocd                    2.5.3      Declarative GitOpts for Kubernetes
...
promtool                  2.40.4     Prometheus CLI tool
...
teleport                  11.1.0     Secure Access for Developers that doesn't get in the way.
