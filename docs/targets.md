...
hugo                      0.125.5    The world’s fastest framework for building websites.
...
terragrunt                0.58.2     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.51.0     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
