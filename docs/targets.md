...
conftest                  0.58.0     Test your configuration files using Open Policy Agent
...
k9s                       0.50.2     Kubernetes CLI To Manage Your Clusters In Style
...
terraform-module-versions 3.3.7      CLI tool that checks Terraform code for module updates. Single binary, no dependencies.
...
terragrunt                0.77.14    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
velero                    1.15.2     Backup and migrate Kubernetes applications and their persistent volumes
