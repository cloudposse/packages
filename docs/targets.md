...
argocd                    2.2.4      Declarative GitOpts for Kubernetes
...
cloudflared               2022.1.3   Argo Tunnel client
...
teleport                  8.1.3      Secure Access for Developers that doesn't get in the way.
...
yq                        4.18.1     yq is a portable command-line YAML processor
```
