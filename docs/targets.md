...
teleport                  15.1.7     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.55.16    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
