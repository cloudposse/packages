...
cloud-nuke                0.41.0     Tool for wiping an aws account DANGER absolutely do not use in production
...
spacectl                  1.14.3     [Spacelift.io](https://spacelift.io/) client and CLI
...
terraform-module-versions 3.3.12     CLI tool that checks Terraform code for module updates. Single binary, no dependencies.
