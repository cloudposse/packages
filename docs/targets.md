...
argocd                    2.2.0      Declarative GitOpts for Kubernetes
assume-role               0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.17.5     Terraform For Teams
atmos                     1.3.12     Universal Tool for DevOps and Cloud Automation
...
cloudflared               2021.12.0  Argo Tunnel client
cloudposse-atlantis       0.9.0.3    Terraform For Teams, enhanced by Cloud Posse
codefresh                 0.78.2     Codefresh CLI
conftest                  0.28.3     Test your configuration files using Open Policy Agent
consul                    1.11.0     Hashicorp consul
ctop                      0.7.6      Top-like interface for container metrics
direnv                    2.29.0     Unclutter your .profile
doctl                     1.68.0     A command line tool for DigitalOcean services
...
k9s                       0.25.12    Kubernetes CLI To Manage Your Clusters In Style
...
kops                      1.22.2     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
kubectl                   1.23.0     Production-Grade Container Scheduling and Management
...
pluto                     5.1.1      A cli tool to help discover deprecated apiVersions in Kubernetes
popeye                    0.9.8      A Kubernetes cluster resource sanitizer
promtool                  2.32.0     Prometheus CLI tool
...
shfmt                     3.4.1      A shell parser, formatter and interpreter (POSIX/Bash/mksh)
...
spotctl                   0.23.0     A unified CLI to manage your [Spot](https://spot.io/) resources.
...
teleport                  8.0.6      Secure Access for Developers that doesn't get in the way.
...
terraform                 1.1.0      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.1.0      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terraform-module-versions 3.1.7      CLI tool that checks Terraform code for module updates. Single binary, no dependencies. linux, osx, windows.
...
terragrunt                0.35.14    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
tflint                    0.34.0     A Pluggable Terraform Linter
...
trivy                     0.21.2     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
yq                        4.16.1     yq is a portable command-line YAML processor
```
