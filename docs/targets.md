...
argocd                    2.5.0      Declarative GitOpts for Kubernetes
assume-role               0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.20.1     Terraform For Teams
atmos                     1.10.5     Universal Tool for DevOps and Cloud Automation
...
sentry-cli                2.8.0      A command line utility to work with Sentry.
...
trivy                     0.33.0     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
