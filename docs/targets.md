...
## Makefile Targets
```text
docker-credential-ecr-login 0.6.0      Automatically gets credentials for Amazon ECR on docker push/docker pull
...
k9s                       0.25.17    Kubernetes CLI To Manage Your Clusters In Style
