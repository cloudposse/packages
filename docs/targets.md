...
argocd                    3.0.11     Declarative GitOpts for Kubernetes
...
codefresh                 0.89.2     Codefresh CLI
...
doctl                     1.133.0    A command line tool for DigitalOcean services
...
pluto                     5.21.9     A cli tool to help discover deprecated apiVersions in Kubernetes
...
sentry-cli                2.47.0     A command line utility to work with Sentry.
...
terragrunt                0.83.1     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
yq                        4.46.1     yq is a portable command-line YAML processor
```
