...
argocd                    3.1.8      Declarative GitOpts for Kubernetes
...
hugo                      0.151.1    The world’s fastest framework for building websites.
...
promtool                  3.7.0      Prometheus CLI tool
...
spacectl                  1.16.1     [Spacelift.io](https://spacelift.io/) client and CLI
...
terragrunt                0.90.0     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
