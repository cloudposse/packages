...
doctl                     1.140.0    A command line tool for DigitalOcean services
...
k6                        1.2.2      A modern load testing tool, using Go and JavaScript - https://k6.io
...
teleport                  18.1.6     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.85.1     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
