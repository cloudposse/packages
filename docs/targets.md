...
argocd                    2.4.6      Declarative GitOpts for Kubernetes
...
ec2-instance-selector     2.3.2      A CLI tool and go library which recommends instance types based on resource criteria like vcpus and memory
...
helm3                     3.9.1      The Kubernetes Package Manager
...
opa                       0.42.2     An open source project to policy-enable your service.
...
sentry-cli                2.4.0      A command line utility to work with Sentry.
...
terraform                 1.2.5      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.2.5      Terraform enables you to safely and predictably create, change, and improve infrastructure.
