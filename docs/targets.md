...
aws-okta                  0.26.3     aws-okta allows users to authenticate with AWS using Okta credentials
...
cloudflared               null       Argo Tunnel client
...
helm                      2.15.2     The Kubernetes Package Manager
helmfile                  0.90.5     Deploy Kubernetes Helm Charts
...
kops-1.12                 null       Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
kubectl-1.13              1.16.2     Production-Grade Container Scheduling and Management
kubectl-1.14              1.16.2     Production-Grade Container Scheduling and Management
kubectx                   0.7.0      Switch faster between clusters and namespaces in kubectl
...
shellcheck                null       ShellCheck, a static analysis tool for shell scripts
...
terraform-0.11            null       Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
terraform-0.12            null       Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
terraform-docs            0.6.0      Generate docs from terraform modules
terragrunt                0.21.3     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
