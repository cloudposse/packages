...
k6                        0.50.0     A modern load testing tool, using Go and JavaScript - https://k6.io
...
terragrunt                0.55.20    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
