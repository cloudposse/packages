...
atmos                     1.193.0    Universal Tool for DevOps and Cloud Automation
...
k9s                       0.50.13    Kubernetes CLI To Manage Your Clusters In Style
...
pandoc                    3.8.1      Universal markup converter
...
sentry-cli                2.56.0     A command line utility to work with Sentry.
...
spacectl                  1.16.0     [Spacelift.io](https://spacelift.io/) client and CLI
...
terragrunt                0.88.1     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.67.0     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
