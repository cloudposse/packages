...
pluto                     5.11.1     A cli tool to help discover deprecated apiVersions in Kubernetes
...
terraform-1               1.3.2      Terraform enables you to safely and predictably create, change, and improve infrastructure.
