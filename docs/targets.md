...
codefresh                 0.74.8     Codefresh CLI
...
minikube                  1.17.0     Run Kubernetes locally
...
terragrunt                0.27.2     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
