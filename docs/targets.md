...
argocd                    2.3.4      Declarative GitOpts for Kubernetes
assume-role               0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.19.3     Terraform For Teams
atmos                     1.4.18     Universal Tool for DevOps and Cloud Automation
awless                    0.1.11     A Mighty CLI for AWS
aws-iam-authenticator     0.5.7      A tool to use AWS IAM credentials to authenticate to a Kubernetes cluster
...
chamber                   2.10.10    CLI for managing secrets
cli53                     0.8.18     Command line tool for Amazon Route 53
cloudflared               2022.5.1   Argo Tunnel client
cloudposse-atlantis       0.9.0.3    Terraform For Teams, enhanced by Cloud Posse
codefresh                 0.79.1     Codefresh CLI
conftest                  0.32.0     Test your configuration files using Open Policy Agent
consul                    1.12.1     Hashicorp consul
ctop                      0.7.7      Top-like interface for container metrics
direnv                    2.31.0     Unclutter your .profile
doctl                     1.76.2     A command line tool for DigitalOcean services
duffle                    0.3.5b1    CNAB installer
ec2-instance-selector     2.3.0      A CLI tool and go library which recommends instance types based on resource criteria like vcpus and memory
...
fetch                     0.4.4      fetch makes it easy to download files, folders, and release assets from a specific public git commit, branch, or tag
figurine                  1.2.0      Print your name in style
fzf                       0.23.1     A command-line fuzzy finder
gh                        2.11.3     The GitHub CLI
...
gomplate                  3.10.0     A flexible commandline tool for template rendering. Supports lots of local and remote datasources.
...
grpcurl                   1.8.6      Like cURL, but for gRPC: Command-line tool for interacting with gRPC servers
hcledit                   0.2.3      A command line editor for HCL
helm                      3.9.0      The Kubernetes Package Manager
...
hugo                      0.99.1     The world’s fastest framework for building websites.
infracost                 0.10.0     Cloud cost estimates for Terraform
jp                        0.2.1      Command line interface to JMESPath
jq                        1.6.0      Command-line JSON processor
json2hcl                  0.0.7      Convert JSON to HCL, and vice versa
jx                        3.2.339    Jenkins-X
k3d                       5.4.1      Little helper to run Rancher Lab's k3s in Docker
k6                        0.38.3     A modern load testing tool, using Go and JavaScript - https://k6.io
...
kops                      1.23.2     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
kubectl                   1.24.1     Production-Grade Container Scheduling and Management
...
kubectl-1.21              1.21.13    Production-Grade Container Scheduling and Management (v1.21)
kubectl-1.22              1.22.10    Production-Grade Container Scheduling and Management (v1.22)
...
minikube                  1.25.2     Run Kubernetes locally
misspell                  0.3.4      Correct commonly misspelled English words in source files
nomad                     OBSOLETE   Hashicorp nomad
opa                       0.40.0     An open source project to policy-enable your service.
pack                      0.26.0     Create cloud native Buildpacks
packer                    1.8.1      Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
pandoc                    2.18       Universal markup converter
pgmetrics                 1.13.0     Postgres metrics
pluto                     5.7.0      A cli tool to help discover deprecated apiVersions in Kubernetes
popeye                    0.10.0     A Kubernetes cluster resource sanitizer
promtool                  2.35.0     Prometheus CLI tool
...
saml2aws                  2.35.0     CLI tool which enables you to login and retrieve AWS temporary credentials using a SAML IDP
scenery                   0.1.5      A Terraform plan output prettifier
sentinel                  OBSOLETE   Hashicorp sentinel
sentry-cli                2.1.0      A command line utility to work with Sentry.
shellcheck                0.8.0      ShellCheck, a static analysis tool for shell scripts
shfmt                     3.5.0      A shell parser, formatter and interpreter (POSIX/Bash/mksh)
...
spacectl                  0.9.2      [Spacelift.io](https://spacelift.io/) client and CLI
...
teleport                  9.3.0      Secure Access for Developers that doesn't get in the way.
...
terraform                 1.2.1      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.2.1      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terraform-module-versions 3.1.10     CLI tool that checks Terraform code for module updates. Single binary, no dependencies. linux, osx, windows.
...
terragrunt                0.37.1     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
tflint                    0.36.2     A Pluggable Terraform Linter
...
tfsec                     1.21.2     Security scanner for your Terraform code
thanos                    0.26.0     Highly available Prometheus setup with long term storage capabilities. CNCF Sandbox project.
trivy                     0.28.1     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
yq                        4.25.2     yq is a portable command-line YAML processor
```
