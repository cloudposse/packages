...
doctl                     1.59.0     A command line tool for DigitalOcean services
...
minikube                  1.19.0     Run Kubernetes locally
...
teleport                  6.1.3      Secure Access for Developers that doesn't get in the way.
...
terraform                 0.15.2     Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-0.15            0.15.2     Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
