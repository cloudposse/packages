...
atlantis                  0.23.4     Terraform For Teams
atmos                     1.33.0     Universal Tool for DevOps and Cloud Automation
...
cloud-nuke                0.29.2     Tool for wiping an aws account DANGER absolutely do not use in production
cloudflared               2023.4.0   Argo Tunnel client
cloudposse-atlantis       OBSOLETE   Terraform For Teams, enhanced by Cloud Posse
codefresh*                0.82.6     Codefresh CLI
...
kubectl-1.25              1.25.8     Production-Grade Container Scheduling and Management (v1.25)
...
pluto                     5.16.0     A cli tool to help discover deprecated apiVersions in Kubernetes
...
sentry-cli                2.17.0     A command line utility to work with Sentry.
...
teleport                  12.2.1     Secure Access for Developers that doesn't get in the way.
...
terraform                 1.4.4      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.4.4      Terraform enables you to safely and predictably create, change, and improve infrastructure.
terraform-config-inspect  0.0.20230324223604+git71b695beb305 A helper library for shallow inspection of Terraform configurations
...
terragrunt                0.45.2     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.39.1     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
