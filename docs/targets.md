...
jx                        3.11.44    Jenkins-X
k3d                       5.8.2      Little helper to run Rancher Lab's k3s in Docker
k6                        0.56.0     A modern load testing tool, using Go and JavaScript - https://k6.io
...
terragrunt                0.73.0     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
