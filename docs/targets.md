...
atmos                     1.0.0      Universal Tool for DevOps and Cloud Automation
...
terragrunt                0.33.0     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
