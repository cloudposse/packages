...
argocd                    2.1.0      Declarative GitOpts for Kubernetes
assume-role               0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.17.2     Terraform For Teams
atmos                     0.21.3     Universal Tool for DevOps and Cloud Automation
...
cloudflared               2021.8.2   Argo Tunnel client
cloudposse-atlantis       0.9.0.3    Terraform For Teams, enhanced by Cloud Posse
codefresh                 0.78.0     Codefresh CLI
conftest                  0.27.0     Test your configuration files using Open Policy Agent
consul                    1.10.1     Hashicorp consul
ctop                      0.7.6      Top-like interface for container metrics
direnv                    2.28.0     Unclutter your .profile
doctl                     1.64.0     A command line tool for DigitalOcean services
...
kubectl                   1.22.1     Production-Grade Container Scheduling and Management
...
kubectl-1.19              1.19.14    Production-Grade Container Scheduling and Management (v1.19)
kubectl-1.20              1.20.10    Production-Grade Container Scheduling and Management (v1.19)
...
pandoc                    2.14.2     Universal markup converter
pgmetrics                 1.11.0     Postgres metrics
pluto                     4.3.0      A cli tool to help discover deprecated apiVersions in Kubernetes
popeye                    0.9.7      A Kubernetes cluster resource sanitizer
promtool                  2.29.1     Prometheus CLI tool
...
teleport                  7.0.3      Secure Access for Developers that doesn't get in the way.
...
terraform                 1.0.5      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.0.5      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terragrunt                0.31.5     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
tflint                    0.31.0     A Pluggable Terraform Linter
...
vault                     1.8.1      Hashicorp vault
vendir                    0.22.0      Easy way to vendor portions of git repos, github releases, helm charts, docker image contents, etc. declaratively.
venona                    1.6.8      Codefresh runtime-environment agent
vert                      0.1.0      Simple CLI for comparing two or more versions
yajsv                     1.4.0      Yet Another JSON Schema Validator [CLI]
yq                        4.12.0     yq is a portable command-line YAML processor
```
