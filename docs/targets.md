...
doctl                     1.73.0     A command line tool for DigitalOcean services
...
opa                       0.39.0     An open source project to policy-enable your service.
...
sentry-cli                2.0.3      A command line utility to work with Sentry.
...
teleport                  9.1.0      Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.36.7     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
tfsec                     1.18.0     Security scanner for your Terraform code
thanos                    0.25.2     Highly available Prometheus setup with long term storage capabilities. CNCF Sandbox project.
trivy                     0.26.0     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
