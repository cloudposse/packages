...
argocd                    2.0.5      Declarative GitOpts for Kubernetes
assume-role               0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.17.2     Terraform For Teams
atmos                     0.21.2     Universal Tool for DevOps and Cloud Automation
...
helm                      3.6.3      The Kubernetes Package Manager
helm2                     2.17.0     The Kubernetes Package Manager
helm3                     3.6.3      The Kubernetes Package Manager
helmfile                  0.140.0    Deploy Kubernetes Helm Charts
htmltest                  0.14.0     :white_check_mark: Test generated HTML for problems
hugo                      0.86.0     The world’s fastest framework for building websites.
jp                        0.1.3      Command line interface to JMESPath
jq                        1.6.0      Command-line JSON processor
json2hcl                  0.0.6      Convert JSON to HCL, and vice versa
jx                        3.2.177    Jenkins-X
k3d                       4.4.7      Little helper to run Rancher Lab's k3s in Docker
...
kubectl                   1.21.3     Production-Grade Container Scheduling and Management
...
kubectl-1.19              1.19.13    Production-Grade Container Scheduling and Management (v1.19)
kubectl-1.20              1.20.9     Production-Grade Container Scheduling and Management (v1.19)
...
minikube                  1.22.0     Run Kubernetes locally
misspell                  0.3.4      Correct commonly misspelled English words in source files
nomad                     OBSOLETE   Hashicorp nomad
opa                       0.31.0     An open source project to policy-enable your service.
pack                      0.20.0     Create cloud native Buildpacks
packer                    1.7.4      Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
...
sentry-cli                1.67.2     A command line utility to work with Sentry.
...
teleport                  6.2.8      Secure Access for Developers that doesn't get in the way.
...
terraform                 1.0.3      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.0.3      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terragrunt                0.31.1     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
