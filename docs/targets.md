...
atmos                     1.76.0     Universal Tool for DevOps and Cloud Automation
...
sentry-cli                2.32.0     A command line utility to work with Sentry.
...
terragrunt                0.58.12    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
