...
aws-vault                 6.3.0      A vault for securely storing and accessing AWS credentials in development environments
...
cloudflared               2021.3.2   Argo Tunnel client
...
helm                      3.5.3      The Kubernetes Package Manager
...
kubectl-1.18              1.18.17    Production-Grade Container Scheduling and Management (v1.18)
kubectl-1.19              1.19.9     Production-Grade Container Scheduling and Management (v1.19)
...
pluto                     4.0.5      A cli tool to help discover deprecated apiVersions in Kubernetes
popeye                    0.9.0      A Kubernetes cluster resource sanitizer
promtool                  2.25.2     Prometheus CLI tool
...
saml2aws                  2.28.4     CLI tool which enables you to login and retrieve AWS temporary credentials using a SAML IDP
scenery                   0.1.5      A Terraform plan output prettifier
sentinel                  OBSOLETE   Hashicorp sentinel
sentry-cli                1.63.1     A command line utility to work with Sentry.
...
terraform                 0.14.8     Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-0.14            0.14.8     Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
terraform-0.15            0.15.0-beta2 Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-docs            0.12.0     Generate docs from terraform modules
...
terragrunt                0.28.15    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
vault                     1.7.0      Hashicorp vault
vendir                    0.17.0      Easy way to vendor portions of git repos, github releases, helm charts, docker image contents, etc. declaratively.
...
yq                        4.6.2      yq is a portable command-line YAML processor
```
