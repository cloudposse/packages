...
kops                      1.21.0     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
opa                       0.30.1     An open source project to policy-enable your service.
