...
k6                        0.59.0     A modern load testing tool, using Go and JavaScript - https://k6.io
...
sentry-cli                2.44.0     A command line utility to work with Sentry.
...
terragrunt                0.78.0     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
yq                        4.45.2     yq is a portable command-line YAML processor
```
