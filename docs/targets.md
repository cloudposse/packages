...
argocd                    1.8.4      Declarative GitOpts for Kubernetes
assume-role               0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.16.1     Terraform For Teams
atmos                     0.15.0     Universal Tool for DevOps and Cloud Automation
...
doctl                     1.56.0     A command line tool for DigitalOcean services
...
saml2aws                  2.28.1     CLI tool which enables you to login and retrieve AWS temporary credentials using a SAML IDP
...
terraform-docs            0.11.0     Generate docs from terraform modules
...
terragrunt                0.28.5     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
yq                        4.5.1      yq is a portable command-line YAML processor
```
