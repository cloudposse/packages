...
helm                      3.12.2     The Kubernetes Package Manager
...
infracost                 0.10.27    Cloud cost estimates for Terraform
...
k6                        0.45.1     A modern load testing tool, using Go and JavaScript - https://k6.io
...
sentry-cli                2.20.4     A command line utility to work with Sentry.
...
teleport                  13.3.1     Secure Access for Developers that doesn't get in the way.
...
terraform                 1.5.4      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.5.4      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terragrunt                0.48.6     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.44.0     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
yq                        4.34.2     yq is a portable command-line YAML processor
```
