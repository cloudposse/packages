...
codefresh                 0.75.16    Codefresh CLI
...
sentry-cli                1.64.1     A command line utility to work with Sentry.
...
spacectl                  0.3.0      [Spacelift.io](https://spacelift.io/) client and CLI
