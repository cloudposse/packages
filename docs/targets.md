...
kubectl                   1.34.3     Production-Grade Container Scheduling and Management
...
terragrunt                0.94.0     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
