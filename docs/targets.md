...
jx                        3.2.202    Jenkins-X
k3d                       5.0.0      Little helper to run Rancher Lab's k3s in Docker
...
terraform                 1.0.8      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terragrunt                0.34.3     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
