...
atlantis                  0.18.0     Terraform For Teams
...
cloudflared               2021.12.4  Argo Tunnel client
cloudposse-atlantis       0.9.0.3    Terraform For Teams, enhanced by Cloud Posse
codefresh                 0.78.2     Codefresh CLI
conftest                  0.29.0     Test your configuration files using Open Policy Agent
...
opa                       0.36.0     An open source project to policy-enable your service.
...
pluto                     5.2.4      A cli tool to help discover deprecated apiVersions in Kubernetes
