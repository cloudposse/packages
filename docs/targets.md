...
hugo                      0.102.0    The world’s fastest framework for building websites.
...
terragrunt                0.38.8     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.31.2     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
