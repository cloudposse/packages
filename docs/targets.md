...
argocd                    2.7.4      Declarative GitOpts for Kubernetes
...
conftest                  0.43.0     Test your configuration files using Open Policy Agent
consul                    1.15.3     Hashicorp consul
ctop                      0.7.7      Top-like interface for container metrics
direnv                    2.32.3     Unclutter your .profile
doctl                     1.96.1     A command line tool for DigitalOcean services
...
ecspresso                 2.2.0      Ecspresso is a deployment tool for Amazon ECS
...
gh                        2.30.0     The GitHub CLI
ghr                       0.16.0     Upload multiple artifacts to GitHub Releases in parallel
github-commenter          0.18.0     Command line utility for creating GitHub comments on Commits, Pull Request Reviews or Issues
...
gitleaks                  8.16.4     Audit git repos for secrets 🔑
...
hcledit                   0.2.8      A command line editor for HCL
helm                      3.12.0     The Kubernetes Package Manager
helm2                     2.17.0     The Kubernetes Package Manager
helm3                     3.12.0     The Kubernetes Package Manager
helmfile                  0.144.0    Deploy Kubernetes Helm Charts
htmltest                  0.17.0     :white_check_mark: Test generated HTML for problems
hugo                      0.113.0    The world’s fastest framework for building websites.
infracost                 0.10.22    Cloud cost estimates for Terraform
...
k3d                       5.5.1      Little helper to run Rancher Lab's k3s in Docker
k6                        0.44.1     A modern load testing tool, using Go and JavaScript - https://k6.io
...
kind                      0.19.0     A tool for running local Kubernetes clusters using Docker
kops                      1.26.3     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
kubectl                   1.27.2     Production-Grade Container Scheduling and Management
...
opa                       0.53.1     An open source project to policy-enable your service.
...
pandoc                    3.1.3      Universal markup converter
...
promtool                  2.44.0     Prometheus CLI tool
...
saml2aws                  2.36.8     CLI tool which enables you to login and retrieve AWS temporary credentials using a SAML IDP
scenery                   OBSOLETE   A Terraform plan output prettifier
sentinel                  OBSOLETE   Hashicorp sentinel
sentry-cli                2.18.1     A command line utility to work with Sentry.
...
spacectl                  0.22.0     [Spacelift.io](https://spacelift.io/) client and CLI
...
teleport                  13.1.0     Secure Access for Developers that doesn't get in the way.
...
terraform                 1.4.6      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.4.6      Terraform enables you to safely and predictably create, change, and improve infrastructure.
terraform-config-inspect  0.0.20230522202058+gitdbe9bfcbfe7a A helper library for shallow inspection of Terraform configurations
...
terragrunt                0.46.2     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.42.0     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
vault                     1.13.2     Hashicorp vault
vendir                    0.34.0      Easy way to vendor portions of git repos, github releases, helm charts, docker image contents, etc. declaratively.
