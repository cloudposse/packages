...
kubectl                   1.18.1     Production-Grade Container Scheduling and Management
...
yq                        3.2.1      yq is a portable command-line YAML processor
```
