...
cloudflared               2024.4.0   Argo Tunnel client
...
teleport                  15.2.2     Secure Access for Developers that doesn't get in the way.
...
terraform                 1.8.1      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.8.1      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terragrunt                0.57.6     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.50.2     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
