...
argocd                    2.4.12     Declarative GitOpts for Kubernetes
assume-role               0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.19.8     Terraform For Teams
atmos                     1.7.1      Universal Tool for DevOps and Cloud Automation
...
gh                        2.15.0     The GitHub CLI
ghr                       0.15.0     Upload multiple artifacts to GitHub Releases in parallel
github-commenter          0.13.0     Command line utility for creating GitHub comments on Commits, Pull Request Reviews or Issues
...
helm                      3.9.4      The Kubernetes Package Manager
helm2                     2.17.0     The Kubernetes Package Manager
helm3                     3.9.4      The Kubernetes Package Manager
helmfile                  0.144.0    Deploy Kubernetes Helm Charts
htmltest                  0.16.0     :white_check_mark: Test generated HTML for problems
hugo                      0.103.1    The world’s fastest framework for building websites.
infracost                 0.10.11    Cloud cost estimates for Terraform
...
k6                        0.40.0     A modern load testing tool, using Go and JavaScript - https://k6.io
k9s                       0.26.4     Kubernetes CLI To Manage Your Clusters In Style
katafygio                 0.8.3      K8s continuous backup to git
kfctl                     1.2.0      Machine Learning Toolkit for Kubernetes
kind                      0.15.0     A tool for running local Kubernetes clusters using Docker
kops                      1.25.0     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
kubectl                   1.25.1     Production-Grade Container Scheduling and Management
...
kubectl-1.22              1.22.14    Production-Grade Container Scheduling and Management (v1.22)
...
minikube                  1.27.0     Run Kubernetes locally
misspell                  0.3.4      Correct commonly misspelled English words in source files
nomad                     OBSOLETE   Hashicorp nomad
opa                       0.44.0     An open source project to policy-enable your service.
...
pluto                     5.10.7     A cli tool to help discover deprecated apiVersions in Kubernetes
popeye                    0.10.1     A Kubernetes cluster resource sanitizer
promtool                  2.38.0     Prometheus CLI tool
...
rancher                   2.6.7      Rancher CLI
rbac-lookup               0.9.1      Find Kubernetes roles and cluster roles bound to any user, service account, or group name.
...
sentry-cli                2.5.2      A command line utility to work with Sentry.
...
spacectl                  0.12.0     [Spacelift.io](https://spacelift.io/) client and CLI
...
teleport                  10.2.2     Secure Access for Developers that doesn't get in the way.
...
terraform                 1.3.0      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.3.0      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terragrunt                0.38.12    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
tflint                    0.40.1     A Pluggable Terraform Linter
...
tfsec                     1.28.0     Security scanner for your Terraform code
thanos                    0.28.0     Highly available Prometheus setup with long term storage capabilities. CNCF Sandbox project.
trivy                     0.32.0     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
