...
argocd                    3.2.5      Declarative GitOpts for Kubernetes
assume-role*              0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.39.0     Terraform For Teams
atmos                     1.204.0    Universal Tool for DevOps and Cloud Automation
...
cilium-cli                0.19.0     CLI to install, manage & troubleshoot Kubernetes clusters running Cilium
...
lazydocker                0.24.4     The lazier way to manage everything docker
...
opa                       1.12.3     An open source project to policy-enable your service.
...
pgmetrics                 1.19.0     Postgres metrics
...
sentry-cli                3.1.0      A command line utility to work with Sentry.
...
spacectl                  1.17.3     [Spacelift.io](https://spacelift.io/) client and CLI
...
velero                    1.17.2     Backup and migrate Kubernetes applications and their persistent volumes
