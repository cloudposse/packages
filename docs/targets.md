...
helm3                     3.12.1     The Kubernetes Package Manager
...
pluto                     5.17.0     A cli tool to help discover deprecated apiVersions in Kubernetes
...
sentry-cli                2.19.0     A command line utility to work with Sentry.
...
terraform-config-inspect  0.0.20230614215431+gitf32df32a01cd A helper library for shallow inspection of Terraform configurations
