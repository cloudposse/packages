...
argocd                    2.5.2      Declarative GitOpts for Kubernetes
assume-role               0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.20.1     Terraform For Teams
atmos                     1.15.0     Universal Tool for DevOps and Cloud Automation
awless                    0.1.11     A Mighty CLI for AWS
aws-iam-authenticator     0.5.10     A tool to use AWS IAM credentials to authenticate to a Kubernetes cluster
...
cloudflared               2022.11.0  Argo Tunnel client
...
kops                      1.25.2     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
kubectl                   1.25.4     Production-Grade Container Scheduling and Management
...
kubectl-1.22              1.22.16    Production-Grade Container Scheduling and Management (v1.22)
kubectl-1.23              1.23.14    Production-Grade Container Scheduling and Management (v1.23)
kubectl-1.24              1.24.8     Production-Grade Container Scheduling and Management (v1.24)
kubectl-1.25              1.25.4     Production-Grade Container Scheduling and Management (v1.25)
...
opa                       0.46.1     An open source project to policy-enable your service.
pack                      0.27.0     Create cloud native Buildpacks
packer                    1.8.4      Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
...
promtool                  2.40.3     Prometheus CLI tool
...
saml2aws                  2.36.1     CLI tool which enables you to login and retrieve AWS temporary credentials using a SAML IDP
scenery                   0.1.5      A Terraform plan output prettifier
sentinel                  OBSOLETE   Hashicorp sentinel
sentry-cli                2.9.0      A command line utility to work with Sentry.
...
spacectl                  0.15.0     [Spacelift.io](https://spacelift.io/) client and CLI
...
teleport                  11.0.3     Secure Access for Developers that doesn't get in the way.
...
terraform                 1.3.5      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.3.5      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terragrunt                0.41.0     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
vault                     1.12.1     Hashicorp vault
vendir                    0.32.0      Easy way to vendor portions of git repos, github releases, helm charts, docker image contents, etc. declaratively.
venona                    1.7.9      Codefresh runtime-environment agent
