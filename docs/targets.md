...
argocd                    2.12.0     Declarative GitOpts for Kubernetes
assume-role*              0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.28.5     Terraform For Teams
atmos                     1.86.0     Universal Tool for DevOps and Cloud Automation
...
aws-iam-authenticator     0.6.22     A tool to use AWS IAM credentials to authenticate to a Kubernetes cluster
...
hugo                      0.132.2    The world’s fastest framework for building websites.
...
kops                      1.29.2     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
kubectl-1.29              1.29.7     Production-Grade Container Scheduling and Management (v1.29)
...
terragrunt                0.66.6     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
