...
argocd                    2.14.7     Declarative GitOpts for Kubernetes
...
sentry-cli                2.42.3     A command line utility to work with Sentry.
...
terragrunt                0.76.1     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
