...
infracost                 0.10.23    Cloud cost estimates for Terraform
...
sentry-cli                2.19.4     A command line utility to work with Sentry.
...
teleport                  13.1.5     Secure Access for Developers that doesn't get in the way.
...
terraform-1               1.5.2      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terragrunt                0.48.0     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
