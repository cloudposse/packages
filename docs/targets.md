...
atmos                     1.3.6      Universal Tool for DevOps and Cloud Automation
...
terragrunt                0.35.8     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
