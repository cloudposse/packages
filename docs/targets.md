...
hugo                      0.151.0    The world’s fastest framework for building websites.
...
terragrunt                0.91.0     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
