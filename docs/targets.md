...
teleport                  17.0.3     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.69.7     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
