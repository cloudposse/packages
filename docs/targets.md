...
argocd                    2.2.5      Declarative GitOpts for Kubernetes
assume-role               0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.18.2     Terraform For Teams
atmos                     1.3.27     Universal Tool for DevOps and Cloud Automation
...
github-status-updater     0.6.0      Command line utility for updating GitHub commit statuses and enabling required status checks for pull requests
...
hugo                      0.92.2     The world’s fastest framework for building websites.
jp                        0.2.1      Command line interface to JMESPath
jq                        1.6.0      Command-line JSON processor
json2hcl                  0.0.6      Convert JSON to HCL, and vice versa
jx                        3.2.253    Jenkins-X
k3d                       5.3.0      Little helper to run Rancher Lab's k3s in Docker
k6                        0.36.0     A modern load testing tool, using Go and JavaScript - https://k6.io
...
kubectl-1.21              1.21.10    Production-Grade Container Scheduling and Management (v1.21)
kubectl-1.22              1.22.7     Production-Grade Container Scheduling and Management (v1.22)
...
opa                       0.37.2     An open source project to policy-enable your service.
pack                      0.24.0     Create cloud native Buildpacks
packer                    1.7.10     Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
pandoc                    2.17.1.1   Universal markup converter
pgmetrics                 1.12.0     Postgres metrics
pluto                     5.4.0      A cli tool to help discover deprecated apiVersions in Kubernetes
popeye                    0.9.8      A Kubernetes cluster resource sanitizer
promtool                  2.33.3     Prometheus CLI tool
...
rbac-lookup               0.8.0      Find Kubernetes roles and cluster roles bound to any user, service account, or group name.
...
sentry-cli                1.72.2     A command line utility to work with Sentry.
...
teleport                  8.3.0      Secure Access for Developers that doesn't get in the way.
...
terraform                 1.1.6      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.1.6      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terragrunt                0.36.1     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
tfsec                     1.2.1      Security scanner for your Terraform code
thanos                    0.24.0     Highly available Prometheus setup with long term storage capabilities. CNCF Sandbox project.
trivy                     0.23.0     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
yq                        4.20.1     yq is a portable command-line YAML processor
```
