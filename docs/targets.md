...
atmos                     1.77.0     Universal Tool for DevOps and Cloud Automation
...
cilium-cli                0.16.9     CLI to install, manage & troubleshoot Kubernetes clusters running Cilium
...
hugo                      0.126.2    The world’s fastest framework for building websites.
...
pack                      0.34.1     Create cloud native Buildpacks
...
teleport                  15.4.0     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.58.13    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
