...
cilium-cli                0.18.1     CLI to install, manage & troubleshoot Kubernetes clusters running Cilium
...
terragrunt                0.75.2     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
