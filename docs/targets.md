...
argocd                    2.6.0      Declarative GitOpts for Kubernetes
assume-role               0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.22.3     Terraform For Teams
atmos                     1.26.1     Universal Tool for DevOps and Cloud Automation
...
codefresh                 0.81.9     Codefresh CLI
...
pluto                     5.13.0     A cli tool to help discover deprecated apiVersions in Kubernetes
...
trivy                     0.37.1     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
