...
atlantis                  0.35.0     Terraform For Teams
atmos                     1.182.0    Universal Tool for DevOps and Cloud Automation
...
cilium-cli                0.18.5     CLI to install, manage & troubleshoot Kubernetes clusters running Cilium
...
cloudflared               2025.7.0   Argo Tunnel client
...
direnv                    2.37.0     Unclutter your .profile
doctl                     1.132.0    A command line tool for DigitalOcean services
...
teleport                  18.0.0     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.82.4     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
thanos                    0.39.1     Highly available Prometheus setup with long term storage capabilities. CNCF Sandbox project.
trivy                     0.64.1     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
