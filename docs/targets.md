...
cloud-nuke                0.31.0     Tool for wiping an aws account DANGER absolutely do not use in production
...
pluto                     5.16.1     A cli tool to help discover deprecated apiVersions in Kubernetes
popeye                    0.11.1     A Kubernetes cluster resource sanitizer
promtool                  2.43.1     Prometheus CLI tool
...
saml2aws                  2.36.7     CLI tool which enables you to login and retrieve AWS temporary credentials using a SAML IDP
