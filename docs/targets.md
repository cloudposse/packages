...
atmos                     1.34.1     Universal Tool for DevOps and Cloud Automation
...
sentry-cli                2.17.4     A command line utility to work with Sentry.
...
teleport                  12.2.4     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.45.4     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.40.0     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
