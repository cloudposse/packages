...
aws-iam-authenticator     0.7.3      A tool to use AWS IAM credentials to authenticate to a Kubernetes cluster
...
codefresh                 0.89.1     Codefresh CLI
...
doctl                     1.131.0    A command line tool for DigitalOcean services
...
hugo                      0.147.9    The world’s fastest framework for building websites.
...
kubectl                   1.33.2     Production-Grade Container Scheduling and Management
...
kubectl-1.31              1.31.10    Production-Grade Container Scheduling and Management (v1.31)
kubectl-1.32              1.32.6     Production-Grade Container Scheduling and Management (v1.32)
...
pluto                     5.21.8     A cli tool to help discover deprecated apiVersions in Kubernetes
...
terragrunt                0.81.10    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
