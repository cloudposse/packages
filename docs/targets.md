...
codefresh                 0.42.1     Codefresh CLI
...
kops                      1.15.1     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
yq                        3.0.1      yq is a portable command-line YAML processor
```
