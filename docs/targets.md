...
codefresh                 0.75.25    Codefresh CLI
...
gonsul                    1.0.0      A stand-alone alternative to git2consul 
...
helmfile                  0.139.8    Deploy Kubernetes Helm Charts
...
terraform                 0.15.5     Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terragrunt                0.29.10    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
yq                        4.9.3      yq is a portable command-line YAML processor
```
