...
hugo                      0.82.1     The world’s fastest framework for building websites.
...
k9s                       0.24.8     Kubernetes CLI To Manage Your Clusters In Style
...
pluto                     4.1.1      A cli tool to help discover deprecated apiVersions in Kubernetes
...
saml2aws                  2.29.0     CLI tool which enables you to login and retrieve AWS temporary credentials using a SAML IDP
...
terragrunt                0.29.1     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
thanos                    0.20.0     Highly available Prometheus setup with long term storage capabilities. CNCF Sandbox project.
trivy                     0.17.1     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
