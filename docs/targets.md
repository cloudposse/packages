...
atmos                     0.22.0     Universal Tool for DevOps and Cloud Automation
...
teleport                  7.1.3      Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.32.4     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
