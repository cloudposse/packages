...
gitleaks                  8.20.0     Audit git repos for secrets 🔑
...
terragrunt                0.67.16    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.56.1     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
