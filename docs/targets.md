...
argocd                    3.0.4      Declarative GitOpts for Kubernetes
...
terragrunt                0.80.4     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
