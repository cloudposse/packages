...
argocd                    2.9.6      Declarative GitOpts for Kubernetes
assume-role*              0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.27.1     Terraform For Teams
atmos                     1.57.0     Universal Tool for DevOps and Cloud Automation
...
conftest                  0.49.0     Test your configuration files using Open Policy Agent
...
k9s                       0.31.7     Kubernetes CLI To Manage Your Clusters In Style
...
pack                      0.33.0     Create cloud native Buildpacks
...
teleport                  15.0.0     Secure Access for Developers that doesn't get in the way.
...
terraform                 1.7.2      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.7.2      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terragrunt                0.55.0     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.49.0     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
yq                        4.40.5     yq is a portable command-line YAML processor
```
