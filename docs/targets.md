...
atmos                     1.4.13     Universal Tool for DevOps and Cloud Automation
...
chamber                   2.10.9     CLI for managing secrets
...
doctl                     1.74.0     A command line tool for DigitalOcean services
...
kind                      0.12.0     A tool for running local Kubernetes clusters using Docker
...
tfsec                     1.20.0     Security scanner for your Terraform code
