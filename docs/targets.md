...
opa                       0.32.1     An open source project to policy-enable your service.
...
terragrunt                0.33.1     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
