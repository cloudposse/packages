...
packer                    1.7.5      Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
...
teleport                  7.1.2      Secure Access for Developers that doesn't get in the way.
