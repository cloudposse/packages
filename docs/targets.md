...
atmos                     1.163.0    Universal Tool for DevOps and Cloud Automation
...
cloudflared               2025.2.0   Argo Tunnel client
cloudposse-atlantis       OBSOLETE   Terraform For Teams, enhanced by Cloud Posse
codefresh                 0.87.6     Codefresh CLI
conftest                  0.57.0     Test your configuration files using Open Policy Agent
consul                    1.16.4     Hashicorp consul
ctop                      0.7.7      Top-like interface for container metrics
direnv                    2.35.0     Unclutter your .profile
doctl                     1.121.0    A command line tool for DigitalOcean services
duffle                    OBSOLETE   CNAB installer
ec2-instance-selector     3.1.0      A CLI tool and go library which recommends instance types based on resource criteria like vcpus and memory
ecspresso                 2.4.5      Ecspresso is a deployment tool for Amazon ECS
...
gitleaks                  8.24.0     Audit git repos for secrets 🔑
go-jsonnet                0.20.0     This an implementation of Jsonnet in pure Go.
gomplate                  4.3.0      A flexible commandline tool for template rendering. Supports lots of local and remote datasources.
...
helm                      3.17.1     The Kubernetes Package Manager
helm2                     2.17.0     The Kubernetes Package Manager
helm3                     3.17.1     The Kubernetes Package Manager
helmfile                  0.144.0    Deploy Kubernetes Helm Charts
htmltest                  0.17.0     :white_check_mark: Test generated HTML for problems
hugo                      0.144.2    The world’s fastest framework for building websites.
infracost                 0.10.40    Cloud cost estimates for Terraform
...
k9s                       0.40.5     Kubernetes CLI To Manage Your Clusters In Style
...
kubectl                   1.32.2     Production-Grade Container Scheduling and Management
...
kubectl-1.29              1.29.14    Production-Grade Container Scheduling and Management (v1.29)
kubectl-1.30              1.30.10    Production-Grade Container Scheduling and Management (v1.30)
kubectl-1.31              1.31.6     Production-Grade Container Scheduling and Management (v1.31)
kubectl-1.32              1.32.2     Production-Grade Container Scheduling and Management (v1.32)
...
opa                       1.1.0      An open source project to policy-enable your service.
pack                      0.36.4     Create cloud native Buildpacks
...
pandoc                    3.6.3      Universal markup converter
...
promtool                  3.2.0      Prometheus CLI tool
...
sentry-cli                2.42.2     A command line utility to work with Sentry.
...
spacectl                  1.10.0     [Spacelift.io](https://spacelift.io/) client and CLI
...
teleport                  17.2.8     Secure Access for Developers that doesn't get in the way.
...
terraform-module-versions 3.3.5      CLI tool that checks Terraform code for module updates. Single binary, no dependencies.
...
terragrunt                0.73.13    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.59.1     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
