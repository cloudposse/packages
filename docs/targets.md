...
argocd                    2.6.5      Declarative GitOpts for Kubernetes
assume-role               0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.23.2     Terraform For Teams
atmos                     1.31.0     Universal Tool for DevOps and Cloud Automation
...
cloud-nuke                0.27.0     Tool for wiping an aws account DANGER absolutely do not use in production
