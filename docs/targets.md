...
argocd                    3.1.0      Declarative GitOpts for Kubernetes
assume-role*              0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.35.1     Terraform For Teams
atmos                     1.187.0    Universal Tool for DevOps and Cloud Automation
...
doctl                     1.139.0    A command line tool for DigitalOcean services
...
terragrunt                0.85.0     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
