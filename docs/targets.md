...
conftest                  0.61.0     Test your configuration files using Open Policy Agent
...
opa                       1.5.0      An open source project to policy-enable your service.
...
spacectl                  1.14.1     [Spacelift.io](https://spacelift.io/) client and CLI
...
trivy                     0.63.0     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
