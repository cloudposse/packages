...
kops                      1.28.1     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
sentry-cli                2.21.4     A command line utility to work with Sentry.
