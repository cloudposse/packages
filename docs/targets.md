...
hugo                      0.125.1    The world’s fastest framework for building websites.
...
terragrunt                0.57.5     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
