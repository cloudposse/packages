...
argocd                    2.12.1     Declarative GitOpts for Kubernetes
assume-role*              0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.28.5     Terraform For Teams
atmos                     1.86.2     Universal Tool for DevOps and Cloud Automation
...
cloudflared               2024.8.2   Argo Tunnel client
...
pluto                     5.20.1     A cli tool to help discover deprecated apiVersions in Kubernetes
...
teleport                  16.1.4     Secure Access for Developers that doesn't get in the way.
