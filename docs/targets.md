...
terragrunt                0.35.17    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
tfsec                     1.0.4      Security scanner for your Terraform code
