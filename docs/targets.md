...
atmos                     1.4.3      Universal Tool for DevOps and Cloud Automation
...
cloudflared               2022.4.0   Argo Tunnel client
...
opa                       0.38.1     An open source project to policy-enable your service.
...
sentry-cli                1.74.3     A command line utility to work with Sentry.
