...
argocd                    2.10.4     Declarative GitOpts for Kubernetes
assume-role*              0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.27.2     Terraform For Teams
atmos                     1.66.0     Universal Tool for DevOps and Cloud Automation
awless*                   0.1.11     A Mighty CLI for AWS
aws-copilot-cli           1.33.2     Tool for developers to build, release and operate containerized applications on AWS App Runner or Amazon ECS on AWS Fargate.
...
cloud-nuke                0.34.0     Tool for wiping an aws account DANGER absolutely do not use in production
cloudflared               2024.3.0   Argo Tunnel client
cloudposse-atlantis       OBSOLETE   Terraform For Teams, enhanced by Cloud Posse
codefresh*                0.87.3     Codefresh CLI
conftest                  0.50.0     Test your configuration files using Open Policy Agent
...
gh                        2.46.0     The GitHub CLI
ghr                       0.16.2     Upload multiple artifacts to GitHub Releases in parallel
github-commenter          0.27.0     Command line utility for creating GitHub comments on Commits, Pull Request Reviews or Issues
github-release*           0.10.0     Commandline app to create and edit releases on Github (and upload artifacts)
github-status-updater     0.9.0      Command line utility for updating GitHub commit statuses and enabling required status checks for pull requests
gitleaks                  8.18.2     Audit git repos for secrets 🔑
go-jsonnet                0.20.0     This an implementation of Jsonnet in pure Go.
gomplate                  3.11.7     A flexible commandline tool for template rendering. Supports lots of local and remote datasources.
...
helm                      3.14.3     The Kubernetes Package Manager
helm2                     2.17.0     The Kubernetes Package Manager
helm3                     3.14.3     The Kubernetes Package Manager
helmfile                  0.144.0    Deploy Kubernetes Helm Charts
htmltest                  0.17.0     :white_check_mark: Test generated HTML for problems
hugo                      0.124.1    The world’s fastest framework for building websites.
infracost                 0.10.34    Cloud cost estimates for Terraform
...
kops                      1.28.4     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
kubectl                   1.29.3     Production-Grade Container Scheduling and Management
...
kubectl-1.27              1.27.12    Production-Grade Container Scheduling and Management (v1.27)
kubectl-1.28              1.28.8     Production-Grade Container Scheduling and Management (v1.28)
kubectl-1.29              1.29.3     Production-Grade Container Scheduling and Management (v1.29)
...
lazydocker                0.23.1     The lazier way to manage everything docker
...
opa                       0.62.1     An open source project to policy-enable your service.
pack                      0.33.2     Create cloud native Buildpacks
packer                    1.10.2     Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
pandoc                    3.1.12.3   Universal markup converter
pgmetrics                 1.16.0     Postgres metrics
pluto                     5.19.0     A cli tool to help discover deprecated apiVersions in Kubernetes
popeye                    0.21.1     A Kubernetes cluster resource sanitizer
promtool                  2.51.0     Prometheus CLI tool
...
saml2aws                  2.36.14    CLI tool which enables you to login and retrieve AWS temporary credentials using a SAML IDP
scenery                   OBSOLETE   A Terraform plan output prettifier
sentinel                  OBSOLETE   Hashicorp sentinel
sentry-cli                2.30.2     A command line utility to work with Sentry.
...
teleport                  15.1.9     Secure Access for Developers that doesn't get in the way.
...
terraform                 1.7.5      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.7.5      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terragrunt                0.55.18    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
thanos                    0.34.1     Highly available Prometheus setup with long term storage capabilities. CNCF Sandbox project.
trivy                     0.50.0     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
yq                        4.42.1     yq is a portable command-line YAML processor
```
