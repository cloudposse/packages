...
aws-iam-authenticator     0.6.26     A tool to use AWS IAM credentials to authenticate to a Kubernetes cluster
...
cilium-cli                0.16.17    CLI to install, manage & troubleshoot Kubernetes clusters running Cilium
...
hugo                      0.134.2    The world’s fastest framework for building websites.
...
sentry-cli                2.36.1     A command line utility to work with Sentry.
...
teleport                  16.3.0     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.67.6     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.55.1     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
