...
aws-vault                 5.0.1      A vault for securely storing and accessing AWS credentials in development environments
...
duffle                    0.3.5-beta.1 CNAB installer
...
k9s                       0.10.9     Kubernetes CLI To Manage Your Clusters In Style
