...
atmos                     1.88.1     Universal Tool for DevOps and Cloud Automation
...
cilium-cli                0.16.18    CLI to install, manage & troubleshoot Kubernetes clusters running Cilium
...
cloudflared               2024.9.1   Argo Tunnel client
...
doctl                     1.114.0    A command line tool for DigitalOcean services
...
gitleaks                  8.19.2     Audit git repos for secrets 🔑
...
kubectl                   1.31.0     Production-Grade Container Scheduling and Management
...
kubectl-1.28              1.28.13    Production-Grade Container Scheduling and Management (v1.28)
kubectl-1.29              1.29.8     Production-Grade Container Scheduling and Management (v1.29)
kubectl-1.30              1.30.4     Production-Grade Container Scheduling and Management (v1.30)
...
opa                       0.68.0     An open source project to policy-enable your service.
...
pandoc                    3.4        Universal markup converter
...
sentry-cli                2.36.2     A command line utility to work with Sentry.
...
teleport                  16.4.1     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.67.13    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.55.2     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
