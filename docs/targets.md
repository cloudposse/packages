...
hugo                      0.112.2    The world’s fastest framework for building websites.
...
terragrunt                0.45.15    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
