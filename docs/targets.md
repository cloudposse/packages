...
atmos                     1.160.3    Universal Tool for DevOps and Cloud Automation
...
terragrunt                0.72.9     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
