...
cloudflared               2023.2.2   Argo Tunnel client
...
spacectl                  0.18.0     [Spacelift.io](https://spacelift.io/) client and CLI
...
teleport                  12.0.4     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.44.1     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.38.0     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
