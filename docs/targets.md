...
atmos                     1.85.0     Universal Tool for DevOps and Cloud Automation
...
cilium-cli                0.16.14    CLI to install, manage & troubleshoot Kubernetes clusters running Cilium
...
codefresh*                0.87.5     Codefresh CLI
...
doctl                     1.110.0    A command line tool for DigitalOcean services
...
kubectl                   1.30.3     Production-Grade Container Scheduling and Management
...
spacectl                  1.2.0      [Spacelift.io](https://spacelift.io/) client and CLI
...
teleport                  16.1.3     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.66.3     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
thanos                    0.36.0     Highly available Prometheus setup with long term storage capabilities. CNCF Sandbox project.
