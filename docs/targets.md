...
atlantis                  0.19.6     Terraform For Teams
...
infracost                 0.10.7     Cloud cost estimates for Terraform
...
kops                      1.24.0     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
opa                       0.42.1     An open source project to policy-enable your service.
...
sentry-cli                2.3.1      A command line utility to work with Sentry.
...
teleport                  10.0.0     Secure Access for Developers that doesn't get in the way.
...
tfschema                  0.7.4      A schema inspector for Terraform providers
tfsec                     1.26.3     Security scanner for your Terraform code
