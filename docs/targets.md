...
hcledit                   0.2.5      A command line editor for HCL
...
kubectl                   1.24.2     Production-Grade Container Scheduling and Management
...
kubectl-1.22              1.22.11    Production-Grade Container Scheduling and Management (v1.22)
...
trivy                     0.29.0     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
