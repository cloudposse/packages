...
argocd                    3.0.3      Declarative GitOpts for Kubernetes
assume-role*              0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.34.0     Terraform For Teams
atmos                     1.176.0    Universal Tool for DevOps and Cloud Automation
...
kind                      0.29.0     A tool for running local Kubernetes clusters using Docker
...
pandoc                    3.7.0.1    Universal markup converter
...
spacectl                  1.14.0     [Spacelift.io](https://spacelift.io/) client and CLI
...
terragrunt                0.80.2     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
velero                    1.16.1     Backup and migrate Kubernetes applications and their persistent volumes
