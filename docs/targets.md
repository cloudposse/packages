...
argocd                    2.4.11     Declarative GitOpts for Kubernetes
...
hugo                      0.103.0    The world’s fastest framework for building websites.
...
kops                      1.24.3     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
teleport                  10.2.1     Secure Access for Developers that doesn't get in the way.
...
tflint                    0.40.0     A Pluggable Terraform Linter
...
trivy                     0.31.3     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
