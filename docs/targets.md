...
argocd                    3.2.2      Declarative GitOpts for Kubernetes
assume-role*              0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.38.0     Terraform For Teams
atmos                     1.202.1    Universal Tool for DevOps and Cloud Automation
...
aws-iam-authenticator     0.7.10     A tool to use AWS IAM credentials to authenticate to a Kubernetes cluster
...
chamber                   3.1.4      CLI for managing secrets
cilium-cli                0.18.9     CLI to install, manage & troubleshoot Kubernetes clusters running Cilium
cli53                     0.8.25     Command line tool for Amazon Route 53
cloud-nuke                0.46.0     Tool for wiping an aws account DANGER absolutely do not use in production
...
conftest                  0.66.0     Test your configuration files using Open Policy Agent
consul                    1.16.4     Hashicorp consul
ctop                      0.7.7      Top-like interface for container metrics
direnv                    2.37.1     Unclutter your .profile
doctl                     1.148.0    A command line tool for DigitalOcean services
duffle                    OBSOLETE   CNAB installer
ec2-instance-selector     3.1.3      A CLI tool and go library which recommends instance types based on resource criteria like vcpus and memory
ecspresso                 2.7.0      Ecspresso is a deployment tool for Amazon ECS
...
github-commenter          0.29.0     Command line utility for creating GitHub comments on Commits, Pull Request Reviews or Issues
...
helm                      4.0.4      The Kubernetes Package Manager
helm2                     2.17.0     The Kubernetes Package Manager
helm3                     3.19.4     The Kubernetes Package Manager
helmfile                  0.144.0    Deploy Kubernetes Helm Charts
htmltest                  0.17.0     :white_check_mark: Test generated HTML for problems
hugo                      0.153.2    The world’s fastest framework for building websites.
infracost                 0.10.43    Cloud cost estimates for Terraform
...
jx                        3.16.43    Jenkins-X
k3d                       5.8.3      Little helper to run Rancher Lab's k3s in Docker
k6                        1.4.2      A modern load testing tool, using Go and JavaScript - https://k6.io
k9s                       0.50.16    Kubernetes CLI To Manage Your Clusters In Style
katafygio                 0.8.3      K8s continuous backup to git
kfctl*                    1.2.0      Machine Learning Toolkit for Kubernetes
kind                      0.31.0     A tool for running local Kubernetes clusters using Docker
kops                      1.34.1     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
kubectl                   1.35.0     Production-Grade Container Scheduling and Management
...
kubectl-1.30              1.30.14    Production-Grade Container Scheduling and Management (v1.30)
kubectl-1.31              1.31.14    Production-Grade Container Scheduling and Management (v1.31)
kubectl-1.32              1.32.11    Production-Grade Container Scheduling and Management (v1.32)
...
lazydocker                0.24.3     The lazier way to manage everything docker
...
opa                       1.12.1     An open source project to policy-enable your service.
pack                      0.39.1     Create cloud native Buildpacks
...
pandoc                    3.8.3      Universal markup converter
pgmetrics                 1.18.0     Postgres metrics
pluto                     5.22.7     A cli tool to help discover deprecated apiVersions in Kubernetes
popeye                    0.22.1     A Kubernetes cluster resource sanitizer
promtool                  3.8.1      Prometheus CLI tool
...
rancher                   2.13.1     Rancher CLI
rbac-lookup               0.10.3     Find Kubernetes roles and cluster roles bound to any user, service account, or group name.
...
sentry-cli                3.0.1      A command line utility to work with Sentry.
...
sops                      3.11.0     Secrets management stinks, use some sops!
spacectl                  1.17.0     [Spacelift.io](https://spacelift.io/) client and CLI
...
stern                     1.33.1     ⎈ Multi pod and container log tailing for Kubernetes
sudosh                    0.3.0      Shell wrapper to run a login shell with `sudo` as the current user for the purpose of audit logging
teleport                  18.6.1     Secure Access for Developers that doesn't get in the way.
...
terraform-docs            0.21.0     Generate docs from terraform modules
terraform-module-versions 3.3.13     CLI tool that checks Terraform code for module updates. Single binary, no dependencies.
...
terragrunt                0.96.1     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
tfsec                     1.28.14    (DEPRECATED: use Trivy instead) Security scanner for your Terraform code
thanos                    0.40.1     Highly available Prometheus setup with long term storage capabilities. CNCF Sandbox project.
trivy                     0.68.2     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
velero                    1.17.1     Backup and migrate Kubernetes applications and their persistent volumes
vendir                    0.45.0     Easy way to vendor portions of git repos, github releases, helm charts, docker image contents, etc. declaratively.
...
yq                        4.50.1     yq is a portable command-line YAML processor
```
