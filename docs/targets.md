...
atmos                     1.4.11     Universal Tool for DevOps and Cloud Automation
...
kubectl                   1.23.6     Production-Grade Container Scheduling and Management
...
spacectl                  0.9.0      [Spacelift.io](https://spacelift.io/) client and CLI
...
teleport                  9.1.2      Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.36.8     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
