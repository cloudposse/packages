...
atmos                     1.3.17     Universal Tool for DevOps and Cloud Automation
...
pandoc                    2.17       Universal markup converter
...
terragrunt                0.35.18    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
