...
argocd                    2.3.0      Declarative GitOpts for Kubernetes
assume-role               0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.19.1     Terraform For Teams
atmos                     1.3.30     Universal Tool for DevOps and Cloud Automation
...
cloudflared               2022.3.1   Argo Tunnel client
...
opa                       0.38.0     An open source project to policy-enable your service.
...
pluto                     5.5.2      A cli tool to help discover deprecated apiVersions in Kubernetes
popeye                    0.9.8      A Kubernetes cluster resource sanitizer
promtool                  2.33.5     Prometheus CLI tool
...
sentry-cli                1.73.2     A command line utility to work with Sentry.
...
teleport                  8.3.4      Secure Access for Developers that doesn't get in the way.
...
terraform-1               1.1.7      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terragrunt                0.36.3     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
tfsec                     1.6.2      Security scanner for your Terraform code
thanos                    0.25.0     Highly available Prometheus setup with long term storage capabilities. CNCF Sandbox project.
trivy                     0.24.2     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
vendir                    0.25.0      Easy way to vendor portions of git repos, github releases, helm charts, docker image contents, etc. declaratively.
...
yq                        4.21.1     yq is a portable command-line YAML processor
```
