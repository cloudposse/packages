...
argocd                    2.4.0      Declarative GitOpts for Kubernetes
assume-role               0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.19.4     Terraform For Teams
atmos                     1.4.21     Universal Tool for DevOps and Cloud Automation
...
cloudflared               2022.6.1   Argo Tunnel client
...
direnv                    2.32.0     Unclutter your .profile
doctl                     1.76.2     A command line tool for DigitalOcean services
duffle                    0.3.5b1    CNAB installer
ec2-instance-selector     2.3.1      A CLI tool and go library which recommends instance types based on resource criteria like vcpus and memory
...
gomplate                  3.11.0     A flexible commandline tool for template rendering. Supports lots of local and remote datasources.
...
hcledit                   0.2.4      A command line editor for HCL
...
jx                        3.2.362    Jenkins-X
k3d                       5.4.3      Little helper to run Rancher Lab's k3s in Docker
...
pluto                     5.8.0      A cli tool to help discover deprecated apiVersions in Kubernetes
popeye                    0.10.0     A Kubernetes cluster resource sanitizer
promtool                  2.36.1     Prometheus CLI tool
...
teleport                  9.3.6      Secure Access for Developers that doesn't get in the way.
...
terraform                 1.2.3      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.2.3      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terragrunt                0.37.4     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
tfsec                     1.26.0     Security scanner for your Terraform code
