...
argocd                    2.8.2      Declarative GitOpts for Kubernetes
...
chamber                   2.13.3     CLI for managing secrets
...
cloudflared               2023.8.2   Argo Tunnel client
cloudposse-atlantis       OBSOLETE   Terraform For Teams, enhanced by Cloud Posse
codefresh*                0.86.0     Codefresh CLI
conftest                  0.45.0     Test your configuration files using Open Policy Agent
consul                    1.16.1     Hashicorp consul
ctop                      0.7.7      Top-like interface for container metrics
direnv                    2.32.3     Unclutter your .profile
doctl                     1.98.1     A command line tool for DigitalOcean services
...
helm3                     3.12.3     The Kubernetes Package Manager
helmfile                  0.144.0    Deploy Kubernetes Helm Charts
htmltest                  0.17.0     :white_check_mark: Test generated HTML for problems
hugo                      0.118.2    The world’s fastest framework for building websites.
infracost                 0.10.29    Cloud cost estimates for Terraform
...
kops                      1.27.1     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
kubectl                   1.28.1     Production-Grade Container Scheduling and Management
...
kubectl-1.25              1.25.13    Production-Grade Container Scheduling and Management (v1.25)
kubectl-1.26              1.26.8     Production-Grade Container Scheduling and Management (v1.26)
kubectl-1.27              1.27.5     Production-Grade Container Scheduling and Management (v1.27)
kubectl-1.28              1.28.1     Production-Grade Container Scheduling and Management (v1.28)
...
pandoc                    3.1.7      Universal markup converter
pgmetrics                 1.15.2     Postgres metrics
pluto                     5.18.3     A cli tool to help discover deprecated apiVersions in Kubernetes
...
sentry-cli                2.20.6     A command line utility to work with Sentry.
...
spacectl                  0.26.0     [Spacelift.io](https://spacelift.io/) client and CLI
spotctl                   0.32.0     A unified CLI to manage your [Spot](https://spot.io/) resources.
...
teleport                  13.3.7     Secure Access for Developers that doesn't get in the way.
...
terraform                 1.5.6      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.5.6      Terraform enables you to safely and predictably create, change, and improve infrastructure.
terraform-config-inspect  0.0.20230825013512+gitb800820f61b8 A helper library for shallow inspection of Terraform configurations
...
terragrunt                0.50.13    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
thanos                    0.32.2     Highly available Prometheus setup with long term storage capabilities. CNCF Sandbox project.
trivy                     0.45.0     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
venona*                   1.10.0     Codefresh runtime-environment agent
