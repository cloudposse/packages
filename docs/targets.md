...
atlantis                  0.18.3     Terraform For Teams
atmos                     1.3.29     Universal Tool for DevOps and Cloud Automation
...
cloudflared               2022.2.2   Argo Tunnel client
...
kops                      1.22.4     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
pluto                     5.5.0      A cli tool to help discover deprecated apiVersions in Kubernetes
...
sentry-cli                1.73.0     A command line utility to work with Sentry.
...
terragrunt                0.36.2     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
tfsec                     1.4.2      Security scanner for your Terraform code
thanos                    0.24.0     Highly available Prometheus setup with long term storage capabilities. CNCF Sandbox project.
trivy                     0.24.1     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
