...
cloudflared               2021.5.5   Argo Tunnel client
...
doctl                     1.60.0     A command line tool for DigitalOcean services
...
helmfile                  0.139.5    Deploy Kubernetes Helm Charts
...
terragrunt                0.29.2     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
