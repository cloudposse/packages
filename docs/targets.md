...
jx                        3.2.404    Jenkins-X
k3d                       5.4.3      Little helper to run Rancher Lab's k3s in Docker
k6                        0.39.0     A modern load testing tool, using Go and JavaScript - https://k6.io
...
opa                       0.42.0     An open source project to policy-enable your service.
...
pluto                     5.10.2     A cli tool to help discover deprecated apiVersions in Kubernetes
...
terragrunt                0.38.4     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
