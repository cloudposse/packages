...
teleport                  16.1.1     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.66.1     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
