...
gitleaks                  8.19.3     Audit git repos for secrets 🔑
...
hugo                      0.135.0    The world’s fastest framework for building websites.
...
sentry-cli                2.36.6     A command line utility to work with Sentry.
...
terragrunt                0.67.15    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
