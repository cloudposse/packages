...
argocd                    2.13.3     Declarative GitOpts for Kubernetes
assume-role*              0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.32.0     Terraform For Teams
atmos                     1.146.1    Universal Tool for DevOps and Cloud Automation
...
cilium-cli                0.16.23    CLI to install, manage & troubleshoot Kubernetes clusters running Cilium
...
doctl                     1.120.2    A command line tool for DigitalOcean services
...
gitleaks                  8.23.0     Audit git repos for secrets 🔑
...
hugo                      0.140.2    The world’s fastest framework for building websites.
...
pack                      0.36.3     Create cloud native Buildpacks
...
sentry-cli                2.40.0     A command line utility to work with Sentry.
...
sops                      3.9.3      Secrets management stinks, use some sops!
...
teleport                  17.1.6     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.72.0     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.58.2     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
velero                    1.15.1     Backup and migrate Kubernetes applications and their persistent volumes
