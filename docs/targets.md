...
atlantis                  0.17.1     Terraform For Teams
...
helm3                     3.6.1      The Kubernetes Package Manager
...
saml2aws                  2.30.0     CLI tool which enables you to login and retrieve AWS temporary credentials using a SAML IDP
...
teleport                  6.2.5      Secure Access for Developers that doesn't get in the way.
