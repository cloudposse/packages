...
argocd                    2.9.0      Declarative GitOpts for Kubernetes
assume-role*              0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.26.0     Terraform For Teams
atmos                     1.50.0     Universal Tool for DevOps and Cloud Automation
awless*                   0.1.11     A Mighty CLI for AWS
aws-copilot-cli           1.32.0     Tool for developers to build, release and operate containerized applications on AWS App Runner or Amazon ECS on AWS Fargate.
...
chamber                   2.13.4     CLI for managing secrets
...
cloudflared               2023.10.0  Argo Tunnel client
cloudposse-atlantis       OBSOLETE   Terraform For Teams, enhanced by Cloud Posse
codefresh*                0.87.2     Codefresh CLI
conftest                  0.46.0     Test your configuration files using Open Policy Agent
consul                    1.17.0     Hashicorp consul
ctop                      0.7.7      Top-like interface for container metrics
direnv                    2.32.3     Unclutter your .profile
doctl                     1.100.0    A command line tool for DigitalOcean services
...
ecspresso                 2.2.4      Ecspresso is a deployment tool for Amazon ECS
...
helm3                     3.13.2     The Kubernetes Package Manager
helmfile                  0.144.0    Deploy Kubernetes Helm Charts
htmltest                  0.17.0     :white_check_mark: Test generated HTML for problems
hugo                      0.120.4    The world’s fastest framework for building websites.
infracost                 0.10.30    Cloud cost estimates for Terraform
...
jx                        3.10.121   Jenkins-X
k3d                       5.6.0      Little helper to run Rancher Lab's k3s in Docker
k6                        0.47.0     A modern load testing tool, using Go and JavaScript - https://k6.io
k9s                       0.28.0     Kubernetes CLI To Manage Your Clusters In Style
...
kops                      1.28.0     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
kubectl                   1.28.3     Production-Grade Container Scheduling and Management
...
kubectl-1.26              1.26.10    Production-Grade Container Scheduling and Management (v1.26)
kubectl-1.27              1.27.7     Production-Grade Container Scheduling and Management (v1.27)
...
opa                       0.58.0     An open source project to policy-enable your service.
pack                      0.32.0     Create cloud native Buildpacks
...
pandoc                    3.1.9      Universal markup converter
pgmetrics                 1.16.0     Postgres metrics
pluto                     5.18.5     A cli tool to help discover deprecated apiVersions in Kubernetes
...
saml2aws                  2.36.12    CLI tool which enables you to login and retrieve AWS temporary credentials using a SAML IDP
scenery                   OBSOLETE   A Terraform plan output prettifier
sentinel                  OBSOLETE   Hashicorp sentinel
sentry-cli                2.21.3     A command line utility to work with Sentry.
...
terraform                 1.6.3      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.6.3      Terraform enables you to safely and predictably create, change, and improve infrastructure.
terraform-config-inspect  0.0.20230925220900+git5a6f8d18746d A helper library for shallow inspection of Terraform configurations
...
terragrunt                0.53.2     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
