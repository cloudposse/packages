...
teleport                  18.5.0     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.93.13    Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.68.1     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
