...
argocd                    2.6.4      Declarative GitOpts for Kubernetes
...
aws-vault                 7.0.1      A vault for securely storing and accessing AWS credentials in development environments
...
cloud-nuke                0.26.0     Tool for wiping an aws account DANGER absolutely do not use in production
cloudflared               2023.3.0   Argo Tunnel client
cloudposse-atlantis       0.9.0.3    Terraform For Teams, enhanced by Cloud Posse
codefresh                 0.82.3     Codefresh CLI
conftest                  0.39.2     Test your configuration files using Open Policy Agent
consul                    1.15.1     Hashicorp consul
ctop                      0.7.7      Top-like interface for container metrics
direnv                    2.32.2     Unclutter your .profile
doctl                     1.93.0     A command line tool for DigitalOcean services
...
helm                      3.11.1     The Kubernetes Package Manager
helm2                     2.17.0     The Kubernetes Package Manager
helm3                     3.11.1     The Kubernetes Package Manager
helmfile                  0.144.0    Deploy Kubernetes Helm Charts
htmltest                  0.17.0     :white_check_mark: Test generated HTML for problems
hugo                      0.111.2    The world’s fastest framework for building websites.
infracost                 0.10.18    Cloud cost estimates for Terraform
...
k3d                       5.4.8      Little helper to run Rancher Lab's k3s in Docker
...
kops                      1.25.3     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
kubectl                   1.26.2     Production-Grade Container Scheduling and Management
...
kubectl-1.24              1.24.11    Production-Grade Container Scheduling and Management (v1.24)
kubectl-1.25              1.25.7     Production-Grade Container Scheduling and Management (v1.25)
...
pandoc                    3.1.1      Universal markup converter
pgmetrics                 1.14.1     Postgres metrics
pluto                     5.15.1     A cli tool to help discover deprecated apiVersions in Kubernetes
popeye                    0.11.1     A Kubernetes cluster resource sanitizer
promtool                  2.42.0     Prometheus CLI tool
...
sentry-cli                2.14.4     A command line utility to work with Sentry.
...
spotctl                   0.28.0     A unified CLI to manage your [Spot](https://spot.io/) resources.
sshm                      1.2.2      Easy connect on EC2 instances thanks to AWS System Manager Agent
stern                     1.23.0     ⎈ Multi pod and container log tailing for Kubernetes
sudosh                    0.3.0      Shell wrapper to run a login shell with `sudo` as the current user for the purpose of audit logging
teleport                  12.1.0     Secure Access for Developers that doesn't get in the way.
...
terraform                 1.3.9      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.3.9      Terraform enables you to safely and predictably create, change, and improve infrastructure.
terraform-config-inspect  0.0.20230223165911+git2d94e3d51111 A helper library for shallow inspection of Terraform configurations
...
terragrunt                0.44.4     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
tflint                    0.45.0     A Pluggable Terraform Linter
...
thanos                    0.30.2     Highly available Prometheus setup with long term storage capabilities. CNCF Sandbox project.
trivy                     0.38.2     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
