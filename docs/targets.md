...
atmos                     1.4.8      Universal Tool for DevOps and Cloud Automation
...
kubectl-1.22              1.22.8     Production-Grade Container Scheduling and Management (v1.22)
...
teleport                  9.0.4      Secure Access for Developers that doesn't get in the way.
