...
argocd                    3.0.0      Declarative GitOpts for Kubernetes
...
doctl                     1.125.1    A command line tool for DigitalOcean services
...
gitleaks                  8.25.1     Audit git repos for secrets 🔑
...
hugo                      0.147.2    The world’s fastest framework for building websites.
...
k9s                       0.50.5     Kubernetes CLI To Manage Your Clusters In Style
...
terragrunt                0.78.2     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
yq                        4.45.3     yq is a portable command-line YAML processor
```
