...
ec2-instance-selector     2.2.0      A CLI tool and go library which recommends instance types based on resource criteria like vcpus and memory
...
trivy                     0.25.3     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
venona                    1.7.3      Codefresh runtime-environment agent
