...
aws-vault                 7.0.2      A vault for securely storing and accessing AWS credentials in development environments
...
kops                      1.25.4     Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
...
opa                       0.50.0     An open source project to policy-enable your service.
...
terraform-config-inspect  0.0.20230308124657+gitd7dec65d5f3a A helper library for shallow inspection of Terraform configurations
