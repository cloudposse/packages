...
argocd                    2.11.1     Declarative GitOpts for Kubernetes
...
terragrunt                0.58.8     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
