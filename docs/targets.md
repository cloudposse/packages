...
argocd                    2.4.13     Declarative GitOpts for Kubernetes
assume-role               0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.19.8     Terraform For Teams
atmos                     1.9.1      Universal Tool for DevOps and Cloud Automation
...
cloudflared               2022.10.0  Argo Tunnel client
...
doctl                     1.82.2     A command line tool for DigitalOcean services
...
sentry-cli                2.7.0      A command line utility to work with Sentry.
...
teleport                  10.3.1     Secure Access for Developers that doesn't get in the way.
