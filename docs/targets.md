...
pluto                     5.3.5      A cli tool to help discover deprecated apiVersions in Kubernetes
...
teleport                  8.2.0      Secure Access for Developers that doesn't get in the way.
...
terraform                 1.1.5      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.1.5      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
tfsec                     1.1.5      Security scanner for your Terraform code
