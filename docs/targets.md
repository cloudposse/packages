...
## Makefile Targets
```text
amtool                    0.22.0     Tool for interacting with the Alertmanager API
...
helm                      3.5.4      The Kubernetes Package Manager
helm2                     2.17.0     The Kubernetes Package Manager
helm3                     3.5.4      The Kubernetes Package Manager
...
sentry-cli                1.64.2     A command line utility to work with Sentry.
...
terragrunt                0.29.5     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
venona                    1.6.5      Codefresh runtime-environment agent
