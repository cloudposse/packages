...
k9s                       0.25.21    Kubernetes CLI To Manage Your Clusters In Style
...
pluto                     5.10.0     A cli tool to help discover deprecated apiVersions in Kubernetes
...
sentry-cli                2.3.0      A command line utility to work with Sentry.
...
teleport                  9.3.9      Secure Access for Developers that doesn't get in the way.
