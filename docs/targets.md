...
atmos                     1.100.0    Universal Tool for DevOps and Cloud Automation
...
cilium-cli                0.16.19    CLI to install, manage & troubleshoot Kubernetes clusters running Cilium
...
cloudflared               2024.10.1  Argo Tunnel client
...
hugo                      0.137.1    The world’s fastest framework for building websites.
...
kind                      0.24.0     A tool for running local Kubernetes clusters using Docker
...
promtool                  2.55.0     Prometheus CLI tool
...
teleport                  16.4.6     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.68.7     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
velero                    1.14.1     Backup and migrate Kubernetes applications and their persistent volumes
...
yq                        4.44.3     yq is a portable command-line YAML processor
```
