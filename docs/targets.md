...
atmos                     1.69.0     Universal Tool for DevOps and Cloud Automation
...
k3d                       5.6.2      Little helper to run Rancher Lab's k3s in Docker
...
terraform-1               1.8.0      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terragrunt                0.56.5     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
