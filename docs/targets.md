...
argocd                    2.5.9      Declarative GitOpts for Kubernetes
assume-role               0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.22.3     Terraform For Teams
atmos                     1.24.0     Universal Tool for DevOps and Cloud Automation
...
cloud-nuke                0.23.0     Tool for wiping an aws account DANGER absolutely do not use in production
...
doctl                     1.92.0     A command line tool for DigitalOcean services
...
helm                      3.11.0     The Kubernetes Package Manager
helm2                     2.17.0     The Kubernetes Package Manager
helm3                     3.11.0     The Kubernetes Package Manager
helmfile                  0.144.0    Deploy Kubernetes Helm Charts
htmltest                  0.17.0     :white_check_mark: Test generated HTML for problems
hugo                      0.110.0    The world’s fastest framework for building websites.
infracost                 0.10.16    Cloud cost estimates for Terraform
...
kubectl                   1.26.1     Production-Grade Container Scheduling and Management
...
kubectl-1.23              1.23.16    Production-Grade Container Scheduling and Management (v1.23)
kubectl-1.24              1.24.10    Production-Grade Container Scheduling and Management (v1.24)
kubectl-1.25              1.25.6     Production-Grade Container Scheduling and Management (v1.25)
...
opa                       0.48.0     An open source project to policy-enable your service.
...
pandoc                    3.0.1      Universal markup converter
pgmetrics                 1.14.0     Postgres metrics
pluto                     5.12.0     A cli tool to help discover deprecated apiVersions in Kubernetes
...
sentry-cli                2.12.0     A command line utility to work with Sentry.
...
teleport                  11.2.3     Secure Access for Developers that doesn't get in the way.
...
terraform                 1.3.7      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.3.7      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terragrunt                0.43.0     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
thanos                    0.30.1     Highly available Prometheus setup with long term storage capabilities. CNCF Sandbox project.
trivy                     0.36.1     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
vendir                    0.32.4      Easy way to vendor portions of git repos, github releases, helm charts, docker image contents, etc. declaratively.
venona                    1.9.6      Codefresh runtime-environment agent
vert                      0.1.0      Simple CLI for comparing two or more versions
yajsv                     1.4.1      Yet Another JSON Schema Validator [CLI]
yq                        4.30.8     yq is a portable command-line YAML processor
```
