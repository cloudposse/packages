...
atmos                     1.4.1      Universal Tool for DevOps and Cloud Automation
...
teleport                  9.0.3      Secure Access for Developers that doesn't get in the way.
...
tfsec                     1.15.4     Security scanner for your Terraform code
thanos                    0.25.2     Highly available Prometheus setup with long term storage capabilities. CNCF Sandbox project.
trivy                     0.25.2     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
