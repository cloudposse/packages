...
atlantis                  0.27.0     Terraform For Teams
atmos                     1.51.0     Universal Tool for DevOps and Cloud Automation
awless*                   0.1.11     A Mighty CLI for AWS
aws-copilot-cli           1.32.1     Tool for developers to build, release and operate containerized applications on AWS App Runner or Amazon ECS on AWS Fargate.
...
consul                    1.17.1     Hashicorp consul
ctop                      0.7.7      Top-like interface for container metrics
direnv                    2.33.0     Unclutter your .profile
doctl                     1.102.0    A command line tool for DigitalOcean services
...
kubectl                   1.29.0     Production-Grade Container Scheduling and Management
...
kubectl-1.26              1.26.12    Production-Grade Container Scheduling and Management (v1.26)
kubectl-1.27              1.27.9     Production-Grade Container Scheduling and Management (v1.27)
kubectl-1.28              1.28.5     Production-Grade Container Scheduling and Management (v1.28)
...
pandoc                    3.1.11     Universal markup converter
...
sentry-cli                2.23.0     A command line utility to work with Sentry.
...
teleport                  14.2.3     Secure Access for Developers that doesn't get in the way.
...
terraform                 1.6.6      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terragrunt                0.54.9     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
