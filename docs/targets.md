...
argocd                    3.0.12     Declarative GitOpts for Kubernetes
assume-role*              0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.35.1     Terraform For Teams
atmos                     1.184.0    Universal Tool for DevOps and Cloud Automation
...
cilium-cli                0.18.6     CLI to install, manage & troubleshoot Kubernetes clusters running Cilium
...
doctl                     1.135.0    A command line tool for DigitalOcean services
...
hugo                      0.148.2    The world’s fastest framework for building websites.
...
kubectl                   1.33.3     Production-Grade Container Scheduling and Management
...
kubectl-1.31              1.31.11    Production-Grade Container Scheduling and Management (v1.31)
kubectl-1.32              1.32.7     Production-Grade Container Scheduling and Management (v1.32)
...
pluto                     5.22.2     A cli tool to help discover deprecated apiVersions in Kubernetes
...
sentry-cli                2.50.2     A command line utility to work with Sentry.
...
teleport                  18.1.1     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.84.1     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.65.0     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
