...
argocd                    2.8.4      Declarative GitOpts for Kubernetes
assume-role*              0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.26.0     Terraform For Teams
atmos                     1.46.0     Universal Tool for DevOps and Cloud Automation
...
kubectl                   1.28.2     Production-Grade Container Scheduling and Management
...
kubectl-1.25              1.25.14    Production-Grade Container Scheduling and Management (v1.25)
kubectl-1.26              1.26.9     Production-Grade Container Scheduling and Management (v1.26)
kubectl-1.27              1.27.6     Production-Grade Container Scheduling and Management (v1.27)
kubectl-1.28              1.28.2     Production-Grade Container Scheduling and Management (v1.28)
...
opa                       0.57.0     An open source project to policy-enable your service.
pack                      0.31.0     Create cloud native Buildpacks
...
teleport                  14.0.3     Secure Access for Developers that doesn't get in the way.
...
terraform                 1.6.1      Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
terraform-1               1.6.1      Terraform enables you to safely and predictably create, change, and improve infrastructure.
...
terragrunt                0.52.3     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
trivy                     0.45.1     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
...
venona*                   1.10.3     Codefresh runtime-environment agent
