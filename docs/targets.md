...
atmos                     1.102.0    Universal Tool for DevOps and Cloud Automation
...
terragrunt                0.68.9     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
