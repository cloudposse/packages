...
argocd                    2.14.5     Declarative GitOpts for Kubernetes
assume-role*              0.3.2      Easily assume AWS roles in your terminal.
atlantis                  0.33.0     Terraform For Teams
atmos                     1.165.3    Universal Tool for DevOps and Cloud Automation
...
doctl                     1.123.0    A command line tool for DigitalOcean services
...
k9s                       0.40.7     Kubernetes CLI To Manage Your Clusters In Style
...
opa                       1.2.0      An open source project to policy-enable your service.
...
teleport                  17.3.3     Secure Access for Developers that doesn't get in the way.
...
terraform-module-versions 3.3.6      CLI tool that checks Terraform code for module updates. Single binary, no dependencies.
...
terragrunt                0.75.5     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
