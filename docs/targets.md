...
gitleaks                  8.19.1     Audit git repos for secrets 🔑
...
terragrunt                0.67.5     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
