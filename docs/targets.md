...
argocd                    2.9.2      Declarative GitOpts for Kubernetes
...
sentry-cli                2.22.3     A command line utility to work with Sentry.
...
teleport                  14.2.0     Secure Access for Developers that doesn't get in the way.
...
terragrunt                0.53.6     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
yq                        4.40.3     yq is a portable command-line YAML processor
```
