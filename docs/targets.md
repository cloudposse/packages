...
terragrunt                0.53.5     Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
...
yq                        4.40.2     yq is a portable command-line YAML processor
```
