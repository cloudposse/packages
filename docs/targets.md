...
teleport                  17.3.4     Secure Access for Developers that doesn't get in the way.
...
trivy                     0.60.0     A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
