...
[![vendir](https://github.com/cloudposse/packages/actions/workflows/vendir.yml/badge.svg?branch=main)](https://github.com/cloudposse/packages/actions?query=workflow%3Avendir) | 0.43.1     | Easy way to vendor portions of git repos, github releases, helm charts, docker image contents, etc. declaratively.
