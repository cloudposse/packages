...
[![awsping](https://github.com/cloudposse/packages/workflows/awsping/badge.svg?branch=master)](https://github.com/cloudposse/packages/actions?query=workflow%3Aawsping) | 0.5.2      | Console tool to check the latency to each Amazon EC2 region
