...
[![aws-okta](https://github.com/cloudposse/packages/workflows/aws-okta/badge.svg?branch=master)](https://github.com/cloudposse/packages/actions?query=workflow%3Aaws-okta) | 1.0.4      | aws-okta allows users to authenticate with AWS using Okta credentials
