...
[![hugo](https://github.com/cloudposse/packages/actions/workflows/hugo.yml/badge.svg?branch=main)](https://github.com/cloudposse/packages/actions?query=workflow%3Ahugo) | 0.146.3    | The world’s fastest framework for building websites.
...
[![terraform-module-versions](https://github.com/cloudposse/packages/actions/workflows/terraform-module-versions.yml/badge.svg?branch=main)](https://github.com/cloudposse/packages/actions?query=workflow%3Aterraform-module-versions) | 3.3.8      | CLI tool that checks Terraform code for module updates. Single binary, no dependencies.
...
[![terragrunt](https://github.com/cloudposse/packages/actions/workflows/terragrunt.yml/badge.svg?branch=main)](https://github.com/cloudposse/packages/actions?query=workflow%3Aterragrunt) | 0.77.14    | Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules.
