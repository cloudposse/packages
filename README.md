...
[![slack-notifier](https://github.com/cloudposse/packages/actions/workflows/slack-notifier.yml/badge.svg?branch=master)](https://github.com/cloudposse/packages/actions?query=workflow%3Aslack-notifier) | 0.7.0      | Command line utility to send messages with attachments to Slack channels via Incoming Webhooks
